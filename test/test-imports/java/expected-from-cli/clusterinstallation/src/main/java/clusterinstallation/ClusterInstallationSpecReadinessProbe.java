...
@software.amazon.jsii.Jsii(module = clusterinstallation.$Module.class, fqn = "clusterinstallation.ClusterInstallationSpecReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(ClusterInstallationSpecReadinessProbe.Jsii$Proxy.class)
public interface ClusterInstallationSpecReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable clusterinstallation.ClusterInstallationSpecReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ClusterInstallationSpecReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ClusterInstallationSpecReadinessProbe}
     */
    public static final class Builder {
        private clusterinstallation.ClusterInstallationSpecReadinessProbeExec exec;
        private java.lang.Number failureThreshold;
        private clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet httpGet;
        ...
        private clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket tcpSocket;
        private java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getExec}
         * @param exec One and only one of the following should be specified.
         *             Exec specifies the action to take.
         * @return {@code this}
         */
        public Builder exec(clusterinstallation.ClusterInstallationSpecReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getHttpGet}
         * @param httpGet HTTPGet specifies the http request to perform.
         * @return {@code this}
         */
        public Builder httpGet(clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies an action involving a TCP port.
         *                  TCP hooks not yet supported TODO: implement a realistic TCP lifecycle hook
         * @return {@code this}
         */
        public Builder tcpSocket(clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link ClusterInstallationSpecReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link ClusterInstallationSpecReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        public ClusterInstallationSpecReadinessProbe build() {
    ...
    /**
     * An implementation for {@link ClusterInstallationSpecReadinessProbe}
     */
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ClusterInstallationSpecReadinessProbe {
        private final clusterinstallation.ClusterInstallationSpecReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet httpGet;
        ...
        private final clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = this.jsiiGet("exec", clusterinstallation.ClusterInstallationSpecReadinessProbeExec.class);
            this.failureThreshold = this.jsiiGet("failureThreshold", java.lang.Number.class);
            this.httpGet = this.jsiiGet("httpGet", clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet.class);
            ...
            this.tcpSocket = this.jsiiGet("tcpSocket", clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket.class);
         ...
         */
        private Jsii$Proxy(final clusterinstallation.ClusterInstallationSpecReadinessProbeExec exec, final java.lang.Number failureThreshold, final clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public clusterinstallation.ClusterInstallationSpecReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public clusterinstallation.ClusterInstallationSpecReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public clusterinstallation.ClusterInstallationSpecReadinessProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("clusterinstallation.ClusterInstallationSpecReadinessProbe"));
        ...
        public boolean equals(Object o) {
            ...
            ClusterInstallationSpecReadinessProbe.Jsii$Proxy that = (ClusterInstallationSpecReadinessProbe.Jsii$Proxy) o;
