 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:59:02.618Z")
@software.amazon.jsii.Jsii(module = jenkins.$Module.class, fqn = "jenkins.JenkinsSpecMasterContainersLivenessProbe")
@software.amazon.jsii.Jsii.Proxy(JenkinsSpecMasterContainersLivenessProbe.Jsii$Proxy.class)
public interface JenkinsSpecMasterContainersLivenessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable jenkins.JenkinsSpecMasterContainersLivenessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link JenkinsSpecMasterContainersLivenessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JenkinsSpecMasterContainersLivenessProbe}
     */
    public static final class Builder {
        private jenkins.JenkinsSpecMasterContainersLivenessProbeExec exec;
        private java.lang.Number failureThreshold;
        private jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet httpGet;
        ...
        private jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket tcpSocket;
        private java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getExec}
         * @param exec One and only one of the following should be specified.
         *             Exec specifies the action to take.
         * @return {@code this}
         */
        public Builder exec(jenkins.JenkinsSpecMasterContainersLivenessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getHttpGet}
         * @param httpGet HTTPGet specifies the http request to perform.
         * @return {@code this}
         */
        public Builder httpGet(jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getTcpSocket}
         * @param tcpSocket TCPSocket specifies an action involving a TCP port.
         *                  TCP hooks not yet supported TODO: implement a realistic TCP lifecycle hook
         * @return {@code this}
         */
        public Builder tcpSocket(jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link JenkinsSpecMasterContainersLivenessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link JenkinsSpecMasterContainersLivenessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        public JenkinsSpecMasterContainersLivenessProbe build() {
    ...
    /**
     * An implementation for {@link JenkinsSpecMasterContainersLivenessProbe}
     */
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JenkinsSpecMasterContainersLivenessProbe {
        private final jenkins.JenkinsSpecMasterContainersLivenessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet httpGet;
        ...
        private final jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = this.jsiiGet("exec", jenkins.JenkinsSpecMasterContainersLivenessProbeExec.class);
            this.failureThreshold = this.jsiiGet("failureThreshold", java.lang.Number.class);
            this.httpGet = this.jsiiGet("httpGet", jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet.class);
            ...
            this.tcpSocket = this.jsiiGet("tcpSocket", jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket.class);
         ...
         */
        private Jsii$Proxy(final jenkins.JenkinsSpecMasterContainersLivenessProbeExec exec, final java.lang.Number failureThreshold, final jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public jenkins.JenkinsSpecMasterContainersLivenessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public jenkins.JenkinsSpecMasterContainersLivenessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public jenkins.JenkinsSpecMasterContainersLivenessProbeTcpSocket getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("jenkins.JenkinsSpecMasterContainersLivenessProbe"));
        ...
        public boolean equals(Object o) {
            ...
            JenkinsSpecMasterContainersLivenessProbe.Jsii$Proxy that = (JenkinsSpecMasterContainersLivenessProbe.Jsii$Proxy) o;
