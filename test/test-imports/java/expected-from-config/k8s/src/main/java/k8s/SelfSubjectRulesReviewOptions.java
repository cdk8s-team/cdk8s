...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.SelfSubjectRulesReviewOptions")
...
public interface SelfSubjectRulesReviewOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull k8s.SelfSubjectRulesReviewSpec getSpec();
    ...
    public static final class Builder {
        private k8s.SelfSubjectRulesReviewSpec spec;
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.SelfSubjectRulesReviewSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SelfSubjectRulesReviewOptions {
        private final k8s.SelfSubjectRulesReviewSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", k8s.SelfSubjectRulesReviewSpec.class);
         ...
         */
        private Jsii$Proxy(final k8s.SelfSubjectRulesReviewSpec spec, final k8s.ObjectMeta metadata) {
        ...
        @Override
        public k8s.SelfSubjectRulesReviewSpec getSpec() {
            return this.spec;
        }
