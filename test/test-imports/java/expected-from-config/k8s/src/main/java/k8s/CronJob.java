...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CronJob")
public class CronJob extends org.cdk8s.ApiObject {
     ...
     */
    public CronJob(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable k8s.CronJobOptions options) {
    ...
    /**
     * A fluent builder for {@link k8s.CronJob}.
     */
    public static final class Builder {
        ...
        private k8s.CronJobOptions.Builder options;
         ...
         */
        public Builder spec(final k8s.CronJobSpec spec) {
            this.options().spec(spec);
            return this;
        }

        /**
         * @returns a newly built instance of {@link k8s.CronJob}.
         */
        public k8s.CronJob build() {
            return new k8s.CronJob(
                this.scope,
                this.name,
        ...
        private k8s.CronJobOptions.Builder options() {
            if (this.options == null) {
                this.options = new k8s.CronJobOptions.Builder();
            }
            return this.options;
        }
    }
