...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.EnvVar")
...
public interface EnvVar extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.EnvVarSource getValueFrom() {
        return null;
    }
    ...
    public static final class Builder {
        ...
        private k8s.EnvVarSource valueFrom;
         ...
         * @return {@code this}
         */
        public Builder valueFrom(k8s.EnvVarSource valueFrom) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EnvVar {
        ...
        private final k8s.EnvVarSource valueFrom;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.valueFrom = this.jsiiGet("valueFrom", k8s.EnvVarSource.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String name, final java.lang.String value, final k8s.EnvVarSource valueFrom) {
        ...
        @Override
        public k8s.EnvVarSource getValueFrom() {
