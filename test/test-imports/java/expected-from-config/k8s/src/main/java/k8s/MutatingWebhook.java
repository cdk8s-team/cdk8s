 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.288Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.MutatingWebhook")
...
public interface MutatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MutatingWebhook {
         ...
         */
        private Jsii$Proxy(final java.util.List<java.lang.String> admissionReviewVersions, final k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.lang.String sideEffects, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final k8s.LabelSelector namespaceSelector, final k8s.LabelSelector objectSelector, final java.lang.String reinvocationPolicy, final java.util.List<k8s.RuleWithOperations> rules, final java.lang.Number timeoutSeconds) {
