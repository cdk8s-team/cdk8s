 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.417Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.SecretListOptions")
...
public interface SecretListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.Secret> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.Secret> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.Secret> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretListOptions {
        private final java.util.List<k8s.Secret> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.Secret.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.Secret> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.Secret> getItems() {
            return this.items;
        }
