...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CertificateSigningRequestOptions")
...
public interface CertificateSigningRequestOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.CertificateSigningRequestSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder {
        ...
        private k8s.CertificateSigningRequestSpec spec;
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.CertificateSigningRequestSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CertificateSigningRequestOptions {
        ...
        private final k8s.CertificateSigningRequestSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = this.jsiiGet("spec", k8s.CertificateSigningRequestSpec.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final k8s.ObjectMeta metadata, final k8s.CertificateSigningRequestSpec spec) {
        ...
        @Override
        public k8s.CertificateSigningRequestSpec getSpec() {
            return this.spec;
        }
