 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.383Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.RBDPersistentVolumeSource")
...
public interface RBDPersistentVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RBDPersistentVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.lang.String image, final java.util.List<java.lang.String> monitors, final java.lang.String fsType, final java.lang.String keyring, final java.lang.String pool, final java.lang.Boolean readOnly, final k8s.SecretReference secretRef, final java.lang.String user) {
