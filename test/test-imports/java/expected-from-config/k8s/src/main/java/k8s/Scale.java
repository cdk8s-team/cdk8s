...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.Scale")
public class Scale extends org.cdk8s.ApiObject {
     ...
     */
    public Scale(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable k8s.ScaleOptions options) {
    ...
    /**
     * A fluent builder for {@link k8s.Scale}.
     */
    public static final class Builder {
        ...
        private k8s.ScaleOptions.Builder options;
         ...
         */
        public Builder spec(final k8s.ScaleSpec spec) {
            this.options().spec(spec);
            return this;
        }

        /**
         * @returns a newly built instance of {@link k8s.Scale}.
         */
        public k8s.Scale build() {
            return new k8s.Scale(
                this.scope,
                this.name,
        ...
        private k8s.ScaleOptions.Builder options() {
            if (this.options == null) {
                this.options = new k8s.ScaleOptions.Builder();
            }
            return this.options;
        }
    }
