 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.109Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CSIVolumeSource")
...
public interface CSIVolumeSource extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.LocalObjectReference getNodePublishSecretRef() {
        return null;
    }
    ...
    public static final class Builder {
        ...
        private k8s.LocalObjectReference nodePublishSecretRef;
         ...
         * @return {@code this}
         */
        public Builder nodePublishSecretRef(k8s.LocalObjectReference nodePublishSecretRef) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CSIVolumeSource {
        ...
        private final k8s.LocalObjectReference nodePublishSecretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.nodePublishSecretRef = this.jsiiGet("nodePublishSecretRef", k8s.LocalObjectReference.class);
         ...
         */
        private Jsii$Proxy(final java.lang.String driver, final java.lang.String fsType, final k8s.LocalObjectReference nodePublishSecretRef, final java.lang.Boolean readOnly, final java.util.Map<java.lang.String, java.lang.String> volumeAttributes) {
        ...
        @Override
        public k8s.LocalObjectReference getNodePublishSecretRef() {
