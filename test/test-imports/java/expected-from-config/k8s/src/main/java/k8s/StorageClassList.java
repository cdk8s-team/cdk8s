...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.StorageClassList")
public class StorageClassList extends org.cdk8s.ApiObject {
     ...
     */
    public StorageClassList(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.NotNull k8s.StorageClassListOptions options) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(name, "name is required"), java.util.Objects.requireNonNull(options, "options is required") });
    }

    /**
     * A fluent builder for {@link k8s.StorageClassList}.
     */
    public static final class Builder {
        ...
        private final k8s.StorageClassListOptions.Builder options;

        private Builder(final software.constructs.Construct scope, final java.lang.String name) {
            this.scope = scope;
            this.name = name;
            this.options = new k8s.StorageClassListOptions.Builder();
        }
         ...
         */
        public Builder items(final java.util.List<k8s.StorageClass> items) {
        ...
        /**
         * @returns a newly built instance of {@link k8s.StorageClassList}.
         */
        public k8s.StorageClassList build() {
            return new k8s.StorageClassList(
                this.scope,
                this.name,
                this.options.build()
            );
