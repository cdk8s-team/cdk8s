 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.444Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.StorageOSVolumeSource")
...
public interface StorageOSVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StorageOSVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.lang.String fsType, final java.lang.Boolean readOnly, final k8s.LocalObjectReference secretRef, final java.lang.String volumeName, final java.lang.String volumeNamespace) {
