 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.118Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CinderVolumeSource")
...
public interface CinderVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CinderVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.lang.String volumeId, final java.lang.String fsType, final java.lang.Boolean readOnly, final k8s.LocalObjectReference secretRef) {
