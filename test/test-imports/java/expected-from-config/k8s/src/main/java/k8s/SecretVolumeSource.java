...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.SecretVolumeSource")
...
public interface SecretVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.lang.Number defaultMode, final java.util.List<k8s.KeyToPath> items, final java.lang.Boolean optional, final java.lang.String secretName) {
