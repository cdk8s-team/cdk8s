 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.419Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.SecurityContext")
...
public interface SecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.Capabilities getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.WindowsSecurityContextOptions getWindowsOptions() {
        return null;
    }
    ...
    public static final class Builder {
        ...
        private k8s.Capabilities capabilities;
        ...
        private k8s.WindowsSecurityContextOptions windowsOptions;
         ...
         * @return {@code this}
         */
        public Builder capabilities(k8s.Capabilities capabilities) {
         ...
         * @return {@code this}
         */
        public Builder windowsOptions(k8s.WindowsSecurityContextOptions windowsOptions) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityContext {
        ...
        private final k8s.Capabilities capabilities;
        ...
        private final k8s.WindowsSecurityContextOptions windowsOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = this.jsiiGet("capabilities", k8s.Capabilities.class);
            ...
            this.windowsOptions = this.jsiiGet("windowsOptions", k8s.WindowsSecurityContextOptions.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.Boolean allowPrivilegeEscalation, final k8s.Capabilities capabilities, final java.lang.Boolean privileged, final java.lang.String procMount, final java.lang.Boolean readOnlyRootFilesystem, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final k8s.SELinuxOptions seLinuxOptions, final k8s.WindowsSecurityContextOptions windowsOptions) {
        ...
        @Override
        public k8s.Capabilities getCapabilities() {
        ...
        @Override
        public k8s.WindowsSecurityContextOptions getWindowsOptions() {
