...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.PodAffinityTerm")
...
public interface PodAffinityTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodAffinityTerm {
         ...
         */
        private Jsii$Proxy(final java.lang.String topologyKey, final k8s.LabelSelector labelSelector, final java.util.List<java.lang.String> namespaces) {
