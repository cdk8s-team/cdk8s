...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.FlexPersistentVolumeSource")
...
public interface FlexPersistentVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements FlexPersistentVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.lang.String driver, final java.lang.String fsType, final java.util.Map<java.lang.String, java.lang.String> options, final java.lang.Boolean readOnly, final k8s.SecretReference secretRef) {
