...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.ScaleOptions")
...
public interface ScaleOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.ScaleSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder {
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.ScaleSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ScaleOptions {
        ...
        private final k8s.ScaleSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = this.jsiiGet("spec", k8s.ScaleSpec.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final k8s.ObjectMeta metadata, final k8s.ScaleSpec spec) {
