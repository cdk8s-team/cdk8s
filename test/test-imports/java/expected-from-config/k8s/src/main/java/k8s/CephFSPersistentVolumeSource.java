 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.113Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CephFSPersistentVolumeSource")
...
public interface CephFSPersistentVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CephFSPersistentVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final k8s.SecretReference secretRef, final java.lang.String user) {
