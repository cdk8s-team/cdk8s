...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.PodSecurityContext")
...
public interface PodSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<k8s.Sysctl> getSysctls() {
        return null;
    }
    ...
    public static final class Builder {
        ...
        private java.util.List<k8s.Sysctl> sysctls;
         ...
         * @return {@code this}
         */
        public Builder sysctls(java.util.List<k8s.Sysctl> sysctls) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityContext {
        ...
        private final java.util.List<k8s.Sysctl> sysctls;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.sysctls = this.jsiiGet("sysctls", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.Sysctl.class)));
         ...
         */
        private Jsii$Proxy(final java.lang.Number fsGroup, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final k8s.SELinuxOptions seLinuxOptions, final java.util.List<java.lang.Number> supplementalGroups, final java.util.List<k8s.Sysctl> sysctls, final k8s.WindowsSecurityContextOptions windowsOptions) {
        ...
        @Override
        public java.util.List<k8s.Sysctl> getSysctls() {
            return this.sysctls;
        }
