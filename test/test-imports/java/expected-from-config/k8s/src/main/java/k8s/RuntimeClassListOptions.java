...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.RuntimeClassListOptions")
...
public interface RuntimeClassListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.RuntimeClass> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.RuntimeClass> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.RuntimeClass> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RuntimeClassListOptions {
        private final java.util.List<k8s.RuntimeClass> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.RuntimeClass.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.RuntimeClass> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.RuntimeClass> getItems() {
            return this.items;
        }
