...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.DeploymentListOptions")
...
public interface DeploymentListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.Deployment> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.Deployment> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.Deployment> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentListOptions {
        private final java.util.List<k8s.Deployment> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.Deployment.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.Deployment> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.Deployment> getItems() {
            return this.items;
        }
