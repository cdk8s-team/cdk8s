 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.331Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.PersistentVolume")
public class PersistentVolume extends org.cdk8s.ApiObject {
     ...
     */
    public PersistentVolume(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable k8s.PersistentVolumeOptions options) {
    ...
    /**
     * A fluent builder for {@link k8s.PersistentVolume}.
     */
    public static final class Builder {
        ...
        private k8s.PersistentVolumeOptions.Builder options;
         ...
         */
        public Builder spec(final k8s.PersistentVolumeSpec spec) {
            this.options().spec(spec);
            return this;
        }

        /**
         * @returns a newly built instance of {@link k8s.PersistentVolume}.
         */
        public k8s.PersistentVolume build() {
            return new k8s.PersistentVolume(
                this.scope,
                this.name,
        ...
        private k8s.PersistentVolumeOptions.Builder options() {
            if (this.options == null) {
                this.options = new k8s.PersistentVolumeOptions.Builder();
            }
            return this.options;
        }
    }
