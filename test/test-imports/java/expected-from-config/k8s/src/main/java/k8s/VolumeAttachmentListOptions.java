...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.VolumeAttachmentListOptions")
...
public interface VolumeAttachmentListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.VolumeAttachment> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.VolumeAttachment> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.VolumeAttachment> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VolumeAttachmentListOptions {
        private final java.util.List<k8s.VolumeAttachment> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.VolumeAttachment.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.VolumeAttachment> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.VolumeAttachment> getItems() {
            return this.items;
        }
