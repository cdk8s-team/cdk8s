...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.Lease")
public class Lease extends org.cdk8s.ApiObject {
     ...
     */
    public Lease(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable k8s.LeaseOptions options) {
    ...
    /**
     * A fluent builder for {@link k8s.Lease}.
     */
    public static final class Builder {
        ...
        private k8s.LeaseOptions.Builder options;
         ...
         */
        public Builder spec(final k8s.LeaseSpec spec) {
            this.options().spec(spec);
            return this;
        }

        /**
         * @returns a newly built instance of {@link k8s.Lease}.
         */
        public k8s.Lease build() {
            return new k8s.Lease(
                this.scope,
                this.name,
        ...
        private k8s.LeaseOptions.Builder options() {
            if (this.options == null) {
                this.options = new k8s.LeaseOptions.Builder();
            }
            return this.options;
        }
    }
