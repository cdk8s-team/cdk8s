 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.1.0 (build df55f5e)", date = "2020-05-13T15:58:47.365Z")
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.PodTemplateSpec")
...
public interface PodTemplateSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable k8s.PodSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder {
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.PodSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodTemplateSpec {
        ...
        private final k8s.PodSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = this.jsiiGet("spec", k8s.PodSpec.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final k8s.ObjectMeta metadata, final k8s.PodSpec spec) {
