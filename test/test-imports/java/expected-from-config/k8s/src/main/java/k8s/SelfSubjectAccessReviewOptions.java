...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.SelfSubjectAccessReviewOptions")
...
public interface SelfSubjectAccessReviewOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull k8s.SelfSubjectAccessReviewSpec getSpec();
    ...
    public static final class Builder {
        private k8s.SelfSubjectAccessReviewSpec spec;
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.SelfSubjectAccessReviewSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SelfSubjectAccessReviewOptions {
        private final k8s.SelfSubjectAccessReviewSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", k8s.SelfSubjectAccessReviewSpec.class);
         ...
         */
        private Jsii$Proxy(final k8s.SelfSubjectAccessReviewSpec spec, final k8s.ObjectMeta metadata) {
        ...
        @Override
        public k8s.SelfSubjectAccessReviewSpec getSpec() {
            return this.spec;
        }
