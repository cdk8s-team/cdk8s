...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.ConfigMapProjection")
...
public interface ConfigMapProjection extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigMapProjection {
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.KeyToPath> items, final java.lang.String name, final java.lang.Boolean optional) {
