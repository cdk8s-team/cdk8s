...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.LocalSubjectAccessReviewOptions")
...
public interface LocalSubjectAccessReviewOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull k8s.SubjectAccessReviewSpec getSpec();
    ...
    public static final class Builder {
        private k8s.SubjectAccessReviewSpec spec;
         ...
         * @return {@code this}
         */
        public Builder spec(k8s.SubjectAccessReviewSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LocalSubjectAccessReviewOptions {
        private final k8s.SubjectAccessReviewSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", k8s.SubjectAccessReviewSpec.class);
         ...
         */
        private Jsii$Proxy(final k8s.SubjectAccessReviewSpec spec, final k8s.ObjectMeta metadata) {
        ...
        @Override
        public k8s.SubjectAccessReviewSpec getSpec() {
            return this.spec;
        }
