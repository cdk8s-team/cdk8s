...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.PersistentVolumeClaimListOptions")
...
public interface PersistentVolumeClaimListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.PersistentVolumeClaim> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.PersistentVolumeClaim> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.PersistentVolumeClaim> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimListOptions {
        private final java.util.List<k8s.PersistentVolumeClaim> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.PersistentVolumeClaim.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.PersistentVolumeClaim> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.PersistentVolumeClaim> getItems() {
            return this.items;
        }
