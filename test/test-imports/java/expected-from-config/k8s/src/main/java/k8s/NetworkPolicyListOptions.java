...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.NetworkPolicyListOptions")
...
public interface NetworkPolicyListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<k8s.NetworkPolicy> getItems();
    ...
    public static final class Builder {
        private java.util.List<k8s.NetworkPolicy> items;
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<k8s.NetworkPolicy> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyListOptions {
        private final java.util.List<k8s.NetworkPolicy> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(k8s.NetworkPolicy.class)));
         ...
         */
        private Jsii$Proxy(final java.util.List<k8s.NetworkPolicy> items, final k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<k8s.NetworkPolicy> getItems() {
            return this.items;
        }
