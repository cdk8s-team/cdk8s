...
@software.amazon.jsii.Jsii(module = k8s.$Module.class, fqn = "k8s.CephFSVolumeSource")
...
public interface CephFSVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CephFSVolumeSource {
         ...
         */
        private Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final k8s.LocalObjectReference secretRef, final java.lang.String user) {
