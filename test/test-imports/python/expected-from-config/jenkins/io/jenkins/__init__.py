...
class Jenkins(cdk8s.ApiObject, metaclass=jsii.JSIIMeta, jsii_type="generated.Jenkins"):
    ...
    :schema:: Jenkins
    """
    def __init__(self, scope: constructs.Construct, name: str, *, metadata: typing.Any=None, spec: typing.Optional["JenkinsSpec"]=None) -> None:
...
class JenkinsOptions():
    def __init__(self, *, metadata: typing.Any=None, spec: typing.Optional["JenkinsSpec"]=None) -> None:
        ...
        :schema:: Jenkins
        """
        if isinstance(spec, dict): spec = JenkinsSpec(**spec)
        self._values = {
        }
...
class JenkinsSpec():
    def __init__(self, *, jenkins_api_settings: "JenkinsSpecJenkinsApiSettings", master: "JenkinsSpecMaster", backup: typing.Optional["JenkinsSpecBackup"]=None, configuration_as_code: typing.Optional["JenkinsSpecConfigurationAsCode"]=None, groovy_scripts: typing.Optional["JenkinsSpecGroovyScripts"]=None, notifications: typing.Optional[typing.List["JenkinsSpecNotifications"]]=None, restore: typing.Optional["JenkinsSpecRestore"]=None, roles: typing.Optional[typing.List["JenkinsSpecRoles"]]=None, seed_jobs: typing.Optional[typing.List["JenkinsSpecSeedJobs"]]=None, service: typing.Optional["JenkinsSpecService"]=None, service_account: typing.Optional["JenkinsSpecServiceAccount"]=None, slave_service: typing.Optional["JenkinsSpecSlaveService"]=None) -> None:
        ...
        :schema:: JenkinsSpec
        """
        if isinstance(jenkins_api_settings, dict): jenkins_api_settings = JenkinsSpecJenkinsApiSettings(**jenkins_api_settings)
        if isinstance(master, dict): master = JenkinsSpecMaster(**master)
        if isinstance(backup, dict): backup = JenkinsSpecBackup(**backup)
        if isinstance(configuration_as_code, dict): configuration_as_code = JenkinsSpecConfigurationAsCode(**configuration_as_code)
        if isinstance(groovy_scripts, dict): groovy_scripts = JenkinsSpecGroovyScripts(**groovy_scripts)
        if isinstance(restore, dict): restore = JenkinsSpecRestore(**restore)
        if isinstance(service, dict): service = JenkinsSpecService(**service)
        if isinstance(service_account, dict): service_account = JenkinsSpecServiceAccount(**service_account)
        if isinstance(slave_service, dict): slave_service = JenkinsSpecSlaveService(**slave_service)
        self._values = {
            'jenkins_api_settings': jenkins_api_settings,
            'master': master,
        }
        if backup is not None: self._values["backup"] = backup
        if configuration_as_code is not None: self._values["configuration_as_code"] = configuration_as_code
        if groovy_scripts is not None: self._values["groovy_scripts"] = groovy_scripts
        if notifications is not None: self._values["notifications"] = notifications
        if restore is not None: self._values["restore"] = restore
        if roles is not None: self._values["roles"] = roles
        if seed_jobs is not None: self._values["seed_jobs"] = seed_jobs
        ...
        if slave_service is not None: self._values["slave_service"] = slave_service
    ...
    @builtins.property
    def configuration_as_code(self) -> typing.Optional["JenkinsSpecConfigurationAsCode"]:
...
class JenkinsSpecBackup():
    def __init__(self, *, action: "JenkinsSpecBackupAction", container_name: str, interval: jsii.Number, make_backup_before_pod_deletion: bool) -> None:
        ...
        """
        if isinstance(action, dict): action = JenkinsSpecBackupAction(**action)
        self._values = {
            'action': action,
...
class JenkinsSpecBackupAction():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecBackupActionExec"]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecBackupActionExec(**exec)
        self._values = {
        }
...
class JenkinsSpecConfigurationAsCode():
    def __init__(self, *, configurations: typing.List["JenkinsSpecConfigurationAsCodeConfigurations"], secret: "JenkinsSpecConfigurationAsCodeSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecConfigurationAsCodeSecret(**secret)
        self._values = {
    ...
    @builtins.property
    def configurations(self) -> typing.List["JenkinsSpecConfigurationAsCodeConfigurations"]:
        """
        schema:
...
class JenkinsSpecGroovyScripts():
    def __init__(self, *, configurations: typing.List["JenkinsSpecGroovyScriptsConfigurations"], secret: "JenkinsSpecGroovyScriptsSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecGroovyScriptsSecret(**secret)
        self._values = {
            'configurations': configurations,
            'secret': secret,
        }
...
class JenkinsSpecMaster():
    def __init__(self, *, disable_csrf_protection: bool, annotations: typing.Optional[typing.Mapping[str, str]]=None, base_plugins: typing.Optional[typing.List["JenkinsSpecMasterBasePlugins"]]=None, containers: typing.Optional[typing.List["JenkinsSpecMasterContainers"]]=None, image_pull_secrets: typing.Optional[typing.List["JenkinsSpecMasterImagePullSecrets"]]=None, labels: typing.Optional[typing.Mapping[str, str]]=None, master_annotations: typing.Optional[typing.Mapping[str, str]]=None, node_selector: typing.Optional[typing.Mapping[str, str]]=None, plugins: typing.Optional[typing.List["JenkinsSpecMasterPlugins"]]=None, security_context: typing.Optional["JenkinsSpecMasterSecurityContext"]=None, tolerations: typing.Optional[typing.List["JenkinsSpecMasterTolerations"]]=None, volumes: typing.Optional[typing.List["JenkinsSpecMasterVolumes"]]=None) -> None:
        ...
        """
        if isinstance(security_context, dict): security_context = JenkinsSpecMasterSecurityContext(**security_context)
        self._values = {
            'disable_csrf_protection': disable_csrf_protection,
        }
        if annotations is not None: self._values["annotations"] = annotations
        if base_plugins is not None: self._values["base_plugins"] = base_plugins
        if containers is not None: self._values["containers"] = containers
        if image_pull_secrets is not None: self._values["image_pull_secrets"] = image_pull_secrets
        if labels is not None: self._values["labels"] = labels
        if master_annotations is not None: self._values["master_annotations"] = master_annotations
        if node_selector is not None: self._values["node_selector"] = node_selector
        if plugins is not None: self._values["plugins"] = plugins
        if security_context is not None: self._values["security_context"] = security_context
    ...
    @builtins.property
    def base_plugins(self) -> typing.Optional[typing.List["JenkinsSpecMasterBasePlugins"]]:
    ...
    @builtins.property
    def image_pull_secrets(self) -> typing.Optional[typing.List["JenkinsSpecMasterImagePullSecrets"]]:
    ...
    @builtins.property
    def tolerations(self) -> typing.Optional[typing.List["JenkinsSpecMasterTolerations"]]:
...
class JenkinsSpecMasterContainers():
    def __init__(self, *, image: str, image_pull_policy: str, name: str, resources: "JenkinsSpecMasterContainersResources", args: typing.Optional[typing.List[str]]=None, command: typing.Optional[typing.List[str]]=None, env: typing.Optional[typing.List["JenkinsSpecMasterContainersEnv"]]=None, env_from: typing.Optional[typing.List["JenkinsSpecMasterContainersEnvFrom"]]=None, lifecycle: typing.Optional["JenkinsSpecMasterContainersLifecycle"]=None, liveness_probe: typing.Optional["JenkinsSpecMasterContainersLivenessProbe"]=None, ports: typing.Optional[typing.List["JenkinsSpecMasterContainersPorts"]]=None, readiness_probe: typing.Optional["JenkinsSpecMasterContainersReadinessProbe"]=None, security_context: typing.Optional["JenkinsSpecMasterContainersSecurityContext"]=None, volume_mounts: typing.Optional[typing.List["JenkinsSpecMasterContainersVolumeMounts"]]=None, working_dir: typing.Optional[str]=None) -> None:
        ...
        """
        if isinstance(resources, dict): resources = JenkinsSpecMasterContainersResources(**resources)
        if isinstance(lifecycle, dict): lifecycle = JenkinsSpecMasterContainersLifecycle(**lifecycle)
        if isinstance(liveness_probe, dict): liveness_probe = JenkinsSpecMasterContainersLivenessProbe(**liveness_probe)
        if isinstance(readiness_probe, dict): readiness_probe = JenkinsSpecMasterContainersReadinessProbe(**readiness_probe)
        if isinstance(security_context, dict): security_context = JenkinsSpecMasterContainersSecurityContext(**security_context)
        self._values = {
            'image': image,
        ...
        if liveness_probe is not None: self._values["liveness_probe"] = liveness_probe
        if ports is not None: self._values["ports"] = ports
        if readiness_probe is not None: self._values["readiness_probe"] = readiness_probe
        if security_context is not None: self._values["security_context"] = security_context
    ...
    @builtins.property
    def env_from(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersEnvFrom"]]:
    ...
    @builtins.property
    def liveness_probe(self) -> typing.Optional["JenkinsSpecMasterContainersLivenessProbe"]:
    ...
    @builtins.property
    def readiness_probe(self) -> typing.Optional["JenkinsSpecMasterContainersReadinessProbe"]:
    ...
    @builtins.property
    def security_context(self) -> typing.Optional["JenkinsSpecMasterContainersSecurityContext"]:
    ...
    @builtins.property
    def volume_mounts(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersVolumeMounts"]]:
...
class JenkinsSpecMasterContainersEnv():
    def __init__(self, *, name: str, value: typing.Optional[str]=None, value_from: typing.Optional["JenkinsSpecMasterContainersEnvValueFrom"]=None) -> None:
        ...
        """
        if isinstance(value_from, dict): value_from = JenkinsSpecMasterContainersEnvValueFrom(**value_from)
        self._values = {
            'name': name,
        }
        if value is not None: self._values["value"] = value
        if value_from is not None: self._values["value_from"] = value_from
...
class JenkinsSpecMasterContainersEnvFrom():
    def __init__(self, *, config_map_ref: typing.Optional["JenkinsSpecMasterContainersEnvFromConfigMapRef"]=None, prefix: typing.Optional[str]=None, secret_ref: typing.Optional["JenkinsSpecMasterContainersEnvFromSecretRef"]=None) -> None:
        ...
        """
        if isinstance(config_map_ref, dict): config_map_ref = JenkinsSpecMasterContainersEnvFromConfigMapRef(**config_map_ref)
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterContainersEnvFromSecretRef(**secret_ref)
        self._values = {
        }
    ...
    @builtins.property
    def config_map_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvFromConfigMapRef"]:
    ...
    @builtins.property
    def secret_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvFromSecretRef"]:
...
class JenkinsSpecMasterContainersEnvValueFrom():
    def __init__(self, *, config_map_key_ref: typing.Optional["JenkinsSpecMasterContainersEnvValueFromConfigMapKeyRef"]=None, field_ref: typing.Optional["JenkinsSpecMasterContainersEnvValueFromFieldRef"]=None, resource_field_ref: typing.Optional["JenkinsSpecMasterContainersEnvValueFromResourceFieldRef"]=None, secret_key_ref: typing.Optional["JenkinsSpecMasterContainersEnvValueFromSecretKeyRef"]=None) -> None:
        ...
        """
        if isinstance(config_map_key_ref, dict): config_map_key_ref = JenkinsSpecMasterContainersEnvValueFromConfigMapKeyRef(**config_map_key_ref)
        if isinstance(field_ref, dict): field_ref = JenkinsSpecMasterContainersEnvValueFromFieldRef(**field_ref)
        if isinstance(resource_field_ref, dict): resource_field_ref = JenkinsSpecMasterContainersEnvValueFromResourceFieldRef(**resource_field_ref)
        if isinstance(secret_key_ref, dict): secret_key_ref = JenkinsSpecMasterContainersEnvValueFromSecretKeyRef(**secret_key_ref)
        self._values = {
        }
        if config_map_key_ref is not None: self._values["config_map_key_ref"] = config_map_key_ref
        if field_ref is not None: self._values["field_ref"] = field_ref
        if resource_field_ref is not None: self._values["resource_field_ref"] = resource_field_ref
        if secret_key_ref is not None: self._values["secret_key_ref"] = secret_key_ref

    @builtins.property
    def config_map_key_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvValueFromConfigMapKeyRef"]:
    ...
    @builtins.property
    def field_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvValueFromFieldRef"]:
    ...
    @builtins.property
    def resource_field_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvValueFromResourceFieldRef"]:
    ...
    @builtins.property
    def secret_key_ref(self) -> typing.Optional["JenkinsSpecMasterContainersEnvValueFromSecretKeyRef"]:
...
class JenkinsSpecMasterContainersEnvValueFromResourceFieldRef():
    def __init__(self, *, resource: str, container_name: typing.Optional[str]=None, divisor: typing.Optional[str]=None) -> None:
        ...
        if divisor is not None: self._values["divisor"] = divisor
...
class JenkinsSpecMasterContainersLifecycle():
    def __init__(self, *, post_start: typing.Optional["JenkinsSpecMasterContainersLifecyclePostStart"]=None, pre_stop: typing.Optional["JenkinsSpecMasterContainersLifecyclePreStop"]=None) -> None:
        ...
        """
        if isinstance(post_start, dict): post_start = JenkinsSpecMasterContainersLifecyclePostStart(**post_start)
        if isinstance(pre_stop, dict): pre_stop = JenkinsSpecMasterContainersLifecyclePreStop(**pre_stop)
        self._values = {
        }
        if post_start is not None: self._values["post_start"] = post_start
        if pre_stop is not None: self._values["pre_stop"] = pre_stop

    @builtins.property
    def post_start(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePostStart"]:
    ...
    @builtins.property
    def pre_stop(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePreStop"]:
...
class JenkinsSpecMasterContainersLifecyclePostStart():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartExec"]=None, http_get: typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartHttpGet"]=None, tcp_socket: typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartTcpSocket"]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecMasterContainersLifecyclePostStartExec(**exec)
        if isinstance(http_get, dict): http_get = JenkinsSpecMasterContainersLifecyclePostStartHttpGet(**http_get)
        if isinstance(tcp_socket, dict): tcp_socket = JenkinsSpecMasterContainersLifecyclePostStartTcpSocket(**tcp_socket)
        self._values = {
        }
        if exec is not None: self._values["exec"] = exec
        if http_get is not None: self._values["http_get"] = http_get
        if tcp_socket is not None: self._values["tcp_socket"] = tcp_socket

    @builtins.property
    def exec(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartExec"]:
    ...
    @builtins.property
    def http_get(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartHttpGet"]:
    ...
    @builtins.property
    def tcp_socket(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePostStartTcpSocket"]:
...
class JenkinsSpecMasterContainersLifecyclePostStartHttpGet():
    ...
    @builtins.property
    def http_headers(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersLifecyclePostStartHttpGetHttpHeaders"]]:
...
class JenkinsSpecMasterContainersLifecyclePostStartHttpGetPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLifecyclePostStartHttpGetPort"):
    ...
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLifecyclePostStartHttpGetPort":
        """
        :param value: -
        """
    ...
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLifecyclePostStartHttpGetPort":
        """
        :param value: -
        """
...
class JenkinsSpecMasterContainersLifecyclePostStartTcpSocketPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLifecyclePostStartTcpSocketPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLifecyclePostStartTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLifecyclePostStartTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersLifecyclePreStop():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopExec"]=None, http_get: typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopHttpGet"]=None, tcp_socket: typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopTcpSocket"]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecMasterContainersLifecyclePreStopExec(**exec)
        if isinstance(http_get, dict): http_get = JenkinsSpecMasterContainersLifecyclePreStopHttpGet(**http_get)
        if isinstance(tcp_socket, dict): tcp_socket = JenkinsSpecMasterContainersLifecyclePreStopTcpSocket(**tcp_socket)
        self._values = {
        }
        if exec is not None: self._values["exec"] = exec
        if http_get is not None: self._values["http_get"] = http_get
    ...
    @builtins.property
    def exec(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopExec"]:
        """One and only one of the following should be specified.
    ...
    @builtins.property
    def http_get(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopHttpGet"]:
        """HTTPGet specifies the http request to perform.
    ...
    @builtins.property
    def tcp_socket(self) -> typing.Optional["JenkinsSpecMasterContainersLifecyclePreStopTcpSocket"]:
        """TCPSocket specifies an action involving a TCP port.
...
class JenkinsSpecMasterContainersLifecyclePreStopHttpGet():
    ...
    @builtins.property
    def http_headers(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersLifecyclePreStopHttpGetHttpHeaders"]]:
        """Custom headers to set in the request.
...
class JenkinsSpecMasterContainersLifecyclePreStopHttpGetPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLifecyclePreStopHttpGetPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLifecyclePreStopHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLifecyclePreStopHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersLifecyclePreStopTcpSocketPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLifecyclePreStopTcpSocketPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLifecyclePreStopTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLifecyclePreStopTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersLivenessProbe():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecMasterContainersLivenessProbeExec"]=None, failure_threshold: typing.Optional[jsii.Number]=None, http_get: typing.Optional["JenkinsSpecMasterContainersLivenessProbeHttpGet"]=None, initial_delay_seconds: typing.Optional[jsii.Number]=None, period_seconds: typing.Optional[jsii.Number]=None, success_threshold: typing.Optional[jsii.Number]=None, tcp_socket: typing.Optional["JenkinsSpecMasterContainersLivenessProbeTcpSocket"]=None, timeout_seconds: typing.Optional[jsii.Number]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecMasterContainersLivenessProbeExec(**exec)
        if isinstance(http_get, dict): http_get = JenkinsSpecMasterContainersLivenessProbeHttpGet(**http_get)
        if isinstance(tcp_socket, dict): tcp_socket = JenkinsSpecMasterContainersLivenessProbeTcpSocket(**tcp_socket)
        self._values = {
        }
        if exec is not None: self._values["exec"] = exec
        if failure_threshold is not None: self._values["failure_threshold"] = failure_threshold
        if http_get is not None: self._values["http_get"] = http_get
        if initial_delay_seconds is not None: self._values["initial_delay_seconds"] = initial_delay_seconds
        if period_seconds is not None: self._values["period_seconds"] = period_seconds
    ...
    @builtins.property
    def http_get(self) -> typing.Optional["JenkinsSpecMasterContainersLivenessProbeHttpGet"]:
        """HTTPGet specifies the http request to perform.
    ...
    @builtins.property
    def tcp_socket(self) -> typing.Optional["JenkinsSpecMasterContainersLivenessProbeTcpSocket"]:
        """TCPSocket specifies an action involving a TCP port.
...
class JenkinsSpecMasterContainersLivenessProbeHttpGet():
    ...
    @builtins.property
    def http_headers(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersLivenessProbeHttpGetHttpHeaders"]]:
        """Custom headers to set in the request.
...
class JenkinsSpecMasterContainersLivenessProbeHttpGetPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLivenessProbeHttpGetPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLivenessProbeHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLivenessProbeHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersLivenessProbeTcpSocketPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersLivenessProbeTcpSocketPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersLivenessProbeTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersLivenessProbeTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersPorts():
    def __init__(self, *, container_port: jsii.Number, host_ip: typing.Optional[str]=None, host_port: typing.Optional[jsii.Number]=None, name: typing.Optional[str]=None, protocol: typing.Optional[str]=None) -> None:
        ...
        if host_ip is not None: self._values["host_ip"] = host_ip
...
class JenkinsSpecMasterContainersReadinessProbe():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecMasterContainersReadinessProbeExec"]=None, failure_threshold: typing.Optional[jsii.Number]=None, http_get: typing.Optional["JenkinsSpecMasterContainersReadinessProbeHttpGet"]=None, initial_delay_seconds: typing.Optional[jsii.Number]=None, period_seconds: typing.Optional[jsii.Number]=None, success_threshold: typing.Optional[jsii.Number]=None, tcp_socket: typing.Optional["JenkinsSpecMasterContainersReadinessProbeTcpSocket"]=None, timeout_seconds: typing.Optional[jsii.Number]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecMasterContainersReadinessProbeExec(**exec)
        if isinstance(http_get, dict): http_get = JenkinsSpecMasterContainersReadinessProbeHttpGet(**http_get)
        if isinstance(tcp_socket, dict): tcp_socket = JenkinsSpecMasterContainersReadinessProbeTcpSocket(**tcp_socket)
        self._values = {
        }
        if exec is not None: self._values["exec"] = exec
        if failure_threshold is not None: self._values["failure_threshold"] = failure_threshold
    ...
    @builtins.property
    def http_get(self) -> typing.Optional["JenkinsSpecMasterContainersReadinessProbeHttpGet"]:
        """HTTPGet specifies the http request to perform.
    ...
    @builtins.property
    def tcp_socket(self) -> typing.Optional["JenkinsSpecMasterContainersReadinessProbeTcpSocket"]:
        """TCPSocket specifies an action involving a TCP port.
...
class JenkinsSpecMasterContainersReadinessProbeHttpGet():
    ...
    @builtins.property
    def http_headers(self) -> typing.Optional[typing.List["JenkinsSpecMasterContainersReadinessProbeHttpGetHttpHeaders"]]:
        """Custom headers to set in the request.
...
class JenkinsSpecMasterContainersReadinessProbeHttpGetPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersReadinessProbeHttpGetPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersReadinessProbeHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersReadinessProbeHttpGetPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersReadinessProbeTcpSocketPort(metaclass=jsii.JSIIMeta, jsii_type="generated.JenkinsSpecMasterContainersReadinessProbeTcpSocketPort"):
    ...
    @jsii.member(jsii_name="fromNumber")
    @builtins.classmethod
    def from_number(cls, value: jsii.Number) -> "JenkinsSpecMasterContainersReadinessProbeTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromNumber", [value])
    ...
    @jsii.member(jsii_name="fromString")
    @builtins.classmethod
    def from_string(cls, value: str) -> "JenkinsSpecMasterContainersReadinessProbeTcpSocketPort":
        """
        :param value: -
        """
        return jsii.sinvoke(cls, "fromString", [value])
...
class JenkinsSpecMasterContainersSecurityContext():
    def __init__(self, *, allow_privilege_escalation: typing.Optional[bool]=None, capabilities: typing.Optional["JenkinsSpecMasterContainersSecurityContextCapabilities"]=None, privileged: typing.Optional[bool]=None, proc_mount: typing.Optional[str]=None, read_only_root_filesystem: typing.Optional[bool]=None, run_as_group: typing.Optional[jsii.Number]=None, run_as_non_root: typing.Optional[bool]=None, run_as_user: typing.Optional[jsii.Number]=None, se_linux_options: typing.Optional["JenkinsSpecMasterContainersSecurityContextSeLinuxOptions"]=None, windows_options: typing.Optional["JenkinsSpecMasterContainersSecurityContextWindowsOptions"]=None) -> None:
        ...
        """
        if isinstance(capabilities, dict): capabilities = JenkinsSpecMasterContainersSecurityContextCapabilities(**capabilities)
        if isinstance(se_linux_options, dict): se_linux_options = JenkinsSpecMasterContainersSecurityContextSeLinuxOptions(**se_linux_options)
        if isinstance(windows_options, dict): windows_options = JenkinsSpecMasterContainersSecurityContextWindowsOptions(**windows_options)
        self._values = {
        }
        if allow_privilege_escalation is not None: self._values["allow_privilege_escalation"] = allow_privilege_escalation
        ...
        if proc_mount is not None: self._values["proc_mount"] = proc_mount
        if read_only_root_filesystem is not None: self._values["read_only_root_filesystem"] = read_only_root_filesystem
        if run_as_group is not None: self._values["run_as_group"] = run_as_group
        if run_as_non_root is not None: self._values["run_as_non_root"] = run_as_non_root
        if run_as_user is not None: self._values["run_as_user"] = run_as_user
        if se_linux_options is not None: self._values["se_linux_options"] = se_linux_options
        if windows_options is not None: self._values["windows_options"] = windows_options
    ...
    @builtins.property
    def capabilities(self) -> typing.Optional["JenkinsSpecMasterContainersSecurityContextCapabilities"]:
    ...
    @builtins.property
    def se_linux_options(self) -> typing.Optional["JenkinsSpecMasterContainersSecurityContextSeLinuxOptions"]:
    ...
    @builtins.property
    def windows_options(self) -> typing.Optional["JenkinsSpecMasterContainersSecurityContextWindowsOptions"]:
...
class JenkinsSpecMasterContainersSecurityContextWindowsOptions():
    def __init__(self, *, gmsa_credential_spec: typing.Optional[str]=None, gmsa_credential_spec_name: typing.Optional[str]=None, run_as_user_name: typing.Optional[str]=None) -> None:
        ...
        if gmsa_credential_spec is not None: self._values["gmsa_credential_spec"] = gmsa_credential_spec
        if gmsa_credential_spec_name is not None: self._values["gmsa_credential_spec_name"] = gmsa_credential_spec_name
        if run_as_user_name is not None: self._values["run_as_user_name"] = run_as_user_name
...
class JenkinsSpecMasterContainersVolumeMounts():
    def __init__(self, *, mount_path: str, name: str, mount_propagation: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, sub_path: typing.Optional[str]=None, sub_path_expr: typing.Optional[str]=None) -> None:
        ...
        if mount_propagation is not None: self._values["mount_propagation"] = mount_propagation
...
class JenkinsSpecMasterSecurityContext():
    def __init__(self, *, fs_group: typing.Optional[jsii.Number]=None, run_as_group: typing.Optional[jsii.Number]=None, run_as_non_root: typing.Optional[bool]=None, run_as_user: typing.Optional[jsii.Number]=None, se_linux_options: typing.Optional["JenkinsSpecMasterSecurityContextSeLinuxOptions"]=None, supplemental_groups: typing.Optional[typing.List[jsii.Number]]=None, sysctls: typing.Optional[typing.List["JenkinsSpecMasterSecurityContextSysctls"]]=None, windows_options: typing.Optional["JenkinsSpecMasterSecurityContextWindowsOptions"]=None) -> None:
        ...
        """
        if isinstance(se_linux_options, dict): se_linux_options = JenkinsSpecMasterSecurityContextSeLinuxOptions(**se_linux_options)
        if isinstance(windows_options, dict): windows_options = JenkinsSpecMasterSecurityContextWindowsOptions(**windows_options)
        self._values = {
        }
        if fs_group is not None: self._values["fs_group"] = fs_group
        if run_as_group is not None: self._values["run_as_group"] = run_as_group
        if run_as_non_root is not None: self._values["run_as_non_root"] = run_as_non_root
        if run_as_user is not None: self._values["run_as_user"] = run_as_user
        if se_linux_options is not None: self._values["se_linux_options"] = se_linux_options
        if supplemental_groups is not None: self._values["supplemental_groups"] = supplemental_groups
        if sysctls is not None: self._values["sysctls"] = sysctls
        if windows_options is not None: self._values["windows_options"] = windows_options
    ...
    @builtins.property
    def se_linux_options(self) -> typing.Optional["JenkinsSpecMasterSecurityContextSeLinuxOptions"]:
    ...
    @builtins.property
    def sysctls(self) -> typing.Optional[typing.List["JenkinsSpecMasterSecurityContextSysctls"]]:
    ...
    @builtins.property
    def windows_options(self) -> typing.Optional["JenkinsSpecMasterSecurityContextWindowsOptions"]:
        """The Windows specific settings applied to all containers.
...
class JenkinsSpecMasterTolerations():
    def __init__(self, *, effect: typing.Optional[str]=None, key: typing.Optional[str]=None, operator: typing.Optional[str]=None, toleration_seconds: typing.Optional[jsii.Number]=None, value: typing.Optional[str]=None) -> None:
        ...
        if operator is not None: self._values["operator"] = operator
        if toleration_seconds is not None: self._values["toleration_seconds"] = toleration_seconds
        if value is not None: self._values["value"] = value
...
class JenkinsSpecMasterVolumes():
    def __init__(self, *, name: str, aws_elastic_block_store: typing.Optional["JenkinsSpecMasterVolumesAwsElasticBlockStore"]=None, azure_disk: typing.Optional["JenkinsSpecMasterVolumesAzureDisk"]=None, azure_file: typing.Optional["JenkinsSpecMasterVolumesAzureFile"]=None, cephfs: typing.Optional["JenkinsSpecMasterVolumesCephfs"]=None, cinder: typing.Optional["JenkinsSpecMasterVolumesCinder"]=None, config_map: typing.Optional["JenkinsSpecMasterVolumesConfigMap"]=None, csi: typing.Optional["JenkinsSpecMasterVolumesCsi"]=None, downward_api: typing.Optional["JenkinsSpecMasterVolumesDownwardApi"]=None, empty_dir: typing.Optional["JenkinsSpecMasterVolumesEmptyDir"]=None, fc: typing.Optional["JenkinsSpecMasterVolumesFc"]=None, flex_volume: typing.Optional["JenkinsSpecMasterVolumesFlexVolume"]=None, flocker: typing.Optional["JenkinsSpecMasterVolumesFlocker"]=None, gce_persistent_disk: typing.Optional["JenkinsSpecMasterVolumesGcePersistentDisk"]=None, git_repo: typing.Optional["JenkinsSpecMasterVolumesGitRepo"]=None, glusterfs: typing.Optional["JenkinsSpecMasterVolumesGlusterfs"]=None, host_path: typing.Optional["JenkinsSpecMasterVolumesHostPath"]=None, iscsi: typing.Optional["JenkinsSpecMasterVolumesIscsi"]=None, nfs: typing.Optional["JenkinsSpecMasterVolumesNfs"]=None, persistent_volume_claim: typing.Optional["JenkinsSpecMasterVolumesPersistentVolumeClaim"]=None, photon_persistent_disk: typing.Optional["JenkinsSpecMasterVolumesPhotonPersistentDisk"]=None, portworx_volume: typing.Optional["JenkinsSpecMasterVolumesPortworxVolume"]=None, projected: typing.Optional["JenkinsSpecMasterVolumesProjected"]=None, quobyte: typing.Optional["JenkinsSpecMasterVolumesQuobyte"]=None, rbd: typing.Optional["JenkinsSpecMasterVolumesRbd"]=None, scale_io: typing.Optional["JenkinsSpecMasterVolumesScaleIo"]=None, secret: typing.Optional["JenkinsSpecMasterVolumesSecret"]=None, storageos: typing.Optional["JenkinsSpecMasterVolumesStorageos"]=None, vsphere_volume: typing.Optional["JenkinsSpecMasterVolumesVsphereVolume"]=None) -> None:
        ...
        """
        if isinstance(aws_elastic_block_store, dict): aws_elastic_block_store = JenkinsSpecMasterVolumesAwsElasticBlockStore(**aws_elastic_block_store)
        if isinstance(azure_disk, dict): azure_disk = JenkinsSpecMasterVolumesAzureDisk(**azure_disk)
        if isinstance(azure_file, dict): azure_file = JenkinsSpecMasterVolumesAzureFile(**azure_file)
        if isinstance(cephfs, dict): cephfs = JenkinsSpecMasterVolumesCephfs(**cephfs)
        if isinstance(cinder, dict): cinder = JenkinsSpecMasterVolumesCinder(**cinder)
        if isinstance(config_map, dict): config_map = JenkinsSpecMasterVolumesConfigMap(**config_map)
        if isinstance(csi, dict): csi = JenkinsSpecMasterVolumesCsi(**csi)
        if isinstance(downward_api, dict): downward_api = JenkinsSpecMasterVolumesDownwardApi(**downward_api)
        if isinstance(empty_dir, dict): empty_dir = JenkinsSpecMasterVolumesEmptyDir(**empty_dir)
        if isinstance(fc, dict): fc = JenkinsSpecMasterVolumesFc(**fc)
        if isinstance(flex_volume, dict): flex_volume = JenkinsSpecMasterVolumesFlexVolume(**flex_volume)
        if isinstance(flocker, dict): flocker = JenkinsSpecMasterVolumesFlocker(**flocker)
        if isinstance(gce_persistent_disk, dict): gce_persistent_disk = JenkinsSpecMasterVolumesGcePersistentDisk(**gce_persistent_disk)
        if isinstance(git_repo, dict): git_repo = JenkinsSpecMasterVolumesGitRepo(**git_repo)
        if isinstance(glusterfs, dict): glusterfs = JenkinsSpecMasterVolumesGlusterfs(**glusterfs)
        if isinstance(host_path, dict): host_path = JenkinsSpecMasterVolumesHostPath(**host_path)
        if isinstance(iscsi, dict): iscsi = JenkinsSpecMasterVolumesIscsi(**iscsi)
        if isinstance(nfs, dict): nfs = JenkinsSpecMasterVolumesNfs(**nfs)
        if isinstance(persistent_volume_claim, dict): persistent_volume_claim = JenkinsSpecMasterVolumesPersistentVolumeClaim(**persistent_volume_claim)
        if isinstance(photon_persistent_disk, dict): photon_persistent_disk = JenkinsSpecMasterVolumesPhotonPersistentDisk(**photon_persistent_disk)
        if isinstance(portworx_volume, dict): portworx_volume = JenkinsSpecMasterVolumesPortworxVolume(**portworx_volume)
        if isinstance(projected, dict): projected = JenkinsSpecMasterVolumesProjected(**projected)
        if isinstance(quobyte, dict): quobyte = JenkinsSpecMasterVolumesQuobyte(**quobyte)
        if isinstance(rbd, dict): rbd = JenkinsSpecMasterVolumesRbd(**rbd)
        if isinstance(scale_io, dict): scale_io = JenkinsSpecMasterVolumesScaleIo(**scale_io)
        if isinstance(secret, dict): secret = JenkinsSpecMasterVolumesSecret(**secret)
        if isinstance(storageos, dict): storageos = JenkinsSpecMasterVolumesStorageos(**storageos)
        if isinstance(vsphere_volume, dict): vsphere_volume = JenkinsSpecMasterVolumesVsphereVolume(**vsphere_volume)
        self._values = {
            'name': name,
        }
        if aws_elastic_block_store is not None: self._values["aws_elastic_block_store"] = aws_elastic_block_store
        if azure_disk is not None: self._values["azure_disk"] = azure_disk
        if azure_file is not None: self._values["azure_file"] = azure_file
        if cephfs is not None: self._values["cephfs"] = cephfs
        if cinder is not None: self._values["cinder"] = cinder
        if config_map is not None: self._values["config_map"] = config_map
        if csi is not None: self._values["csi"] = csi
        if downward_api is not None: self._values["downward_api"] = downward_api
        if empty_dir is not None: self._values["empty_dir"] = empty_dir
        if fc is not None: self._values["fc"] = fc
        if flex_volume is not None: self._values["flex_volume"] = flex_volume
        if flocker is not None: self._values["flocker"] = flocker
        if gce_persistent_disk is not None: self._values["gce_persistent_disk"] = gce_persistent_disk
        if git_repo is not None: self._values["git_repo"] = git_repo
        if glusterfs is not None: self._values["glusterfs"] = glusterfs
        if host_path is not None: self._values["host_path"] = host_path
        if iscsi is not None: self._values["iscsi"] = iscsi
        if nfs is not None: self._values["nfs"] = nfs
        if persistent_volume_claim is not None: self._values["persistent_volume_claim"] = persistent_volume_claim
        if photon_persistent_disk is not None: self._values["photon_persistent_disk"] = photon_persistent_disk
        if portworx_volume is not None: self._values["portworx_volume"] = portworx_volume
        if projected is not None: self._values["projected"] = projected
        if quobyte is not None: self._values["quobyte"] = quobyte
        if rbd is not None: self._values["rbd"] = rbd
        if scale_io is not None: self._values["scale_io"] = scale_io
        if secret is not None: self._values["secret"] = secret
        if storageos is not None: self._values["storageos"] = storageos
        if vsphere_volume is not None: self._values["vsphere_volume"] = vsphere_volume
    ...
    @builtins.property
    def aws_elastic_block_store(self) -> typing.Optional["JenkinsSpecMasterVolumesAwsElasticBlockStore"]:
    ...
    @builtins.property
    def gce_persistent_disk(self) -> typing.Optional["JenkinsSpecMasterVolumesGcePersistentDisk"]:
    ...
    @builtins.property
    def persistent_volume_claim(self) -> typing.Optional["JenkinsSpecMasterVolumesPersistentVolumeClaim"]:
    ...
    @builtins.property
    def photon_persistent_disk(self) -> typing.Optional["JenkinsSpecMasterVolumesPhotonPersistentDisk"]:
    ...
    @builtins.property
    def portworx_volume(self) -> typing.Optional["JenkinsSpecMasterVolumesPortworxVolume"]:
    ...
    @builtins.property
    def vsphere_volume(self) -> typing.Optional["JenkinsSpecMasterVolumesVsphereVolume"]:
...
class JenkinsSpecMasterVolumesAzureDisk():
    def __init__(self, *, disk_name: str, disk_uri: str, caching_mode: typing.Optional[str]=None, fs_type: typing.Optional[str]=None, kind: typing.Optional[str]=None, read_only: typing.Optional[bool]=None) -> None:
        ...
        if caching_mode is not None: self._values["caching_mode"] = caching_mode
        if fs_type is not None: self._values["fs_type"] = fs_type
...
class JenkinsSpecMasterVolumesCephfs():
    def __init__(self, *, monitors: typing.List[str], path: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, secret_file: typing.Optional[str]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesCephfsSecretRef"]=None, user: typing.Optional[str]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesCephfsSecretRef(**secret_ref)
        self._values = {
            'monitors': monitors,
        }
        if path is not None: self._values["path"] = path
        if read_only is not None: self._values["read_only"] = read_only
        if secret_file is not None: self._values["secret_file"] = secret_file
        if secret_ref is not None: self._values["secret_ref"] = secret_ref
        if user is not None: self._values["user"] = user
...
class JenkinsSpecMasterVolumesCinder():
    def __init__(self, *, volume_id: str, fs_type: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesCinderSecretRef"]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesCinderSecretRef(**secret_ref)
        self._values = {
            'volume_id': volume_id,
        }
        if fs_type is not None: self._values["fs_type"] = fs_type
...
class JenkinsSpecMasterVolumesConfigMap():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesConfigMapItems"]]:
...
class JenkinsSpecMasterVolumesCsi():
    def __init__(self, *, driver: str, fs_type: typing.Optional[str]=None, node_publish_secret_ref: typing.Optional["JenkinsSpecMasterVolumesCsiNodePublishSecretRef"]=None, read_only: typing.Optional[bool]=None, volume_attributes: typing.Optional[typing.Mapping[str, str]]=None) -> None:
        ...
        """
        if isinstance(node_publish_secret_ref, dict): node_publish_secret_ref = JenkinsSpecMasterVolumesCsiNodePublishSecretRef(**node_publish_secret_ref)
        self._values = {
            'driver': driver,
        }
        if fs_type is not None: self._values["fs_type"] = fs_type
    ...
    @builtins.property
    def node_publish_secret_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesCsiNodePublishSecretRef"]:
...
class JenkinsSpecMasterVolumesDownwardApi():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesDownwardApiItems"]]:
...
class JenkinsSpecMasterVolumesDownwardApiItems():
    def __init__(self, *, path: str, field_ref: typing.Optional["JenkinsSpecMasterVolumesDownwardApiItemsFieldRef"]=None, mode: typing.Optional[jsii.Number]=None, resource_field_ref: typing.Optional["JenkinsSpecMasterVolumesDownwardApiItemsResourceFieldRef"]=None) -> None:
        ...
        """
        if isinstance(field_ref, dict): field_ref = JenkinsSpecMasterVolumesDownwardApiItemsFieldRef(**field_ref)
        if isinstance(resource_field_ref, dict): resource_field_ref = JenkinsSpecMasterVolumesDownwardApiItemsResourceFieldRef(**resource_field_ref)
        self._values = {
            'path': path,
        }
        if field_ref is not None: self._values["field_ref"] = field_ref
    ...
    @builtins.property
    def field_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesDownwardApiItemsFieldRef"]:
    ...
    @builtins.property
    def resource_field_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesDownwardApiItemsResourceFieldRef"]:
...
class JenkinsSpecMasterVolumesFc():
    def __init__(self, *, fs_type: typing.Optional[str]=None, lun: typing.Optional[jsii.Number]=None, read_only: typing.Optional[bool]=None, target_ww_ns: typing.Optional[typing.List[str]]=None, wwids: typing.Optional[typing.List[str]]=None) -> None:
        ...
        if fs_type is not None: self._values["fs_type"] = fs_type
        if lun is not None: self._values["lun"] = lun
        if read_only is not None: self._values["read_only"] = read_only
        if target_ww_ns is not None: self._values["target_ww_ns"] = target_ww_ns
        if wwids is not None: self._values["wwids"] = wwids
...
class JenkinsSpecMasterVolumesFlexVolume():
    def __init__(self, *, driver: str, fs_type: typing.Optional[str]=None, options: typing.Optional[typing.Mapping[str, str]]=None, read_only: typing.Optional[bool]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesFlexVolumeSecretRef"]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesFlexVolumeSecretRef(**secret_ref)
        self._values = {
            'driver': driver,
        }
        if fs_type is not None: self._values["fs_type"] = fs_type
    ...
    @builtins.property
    def secret_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesFlexVolumeSecretRef"]:
...
class JenkinsSpecMasterVolumesFlocker():
    def __init__(self, *, dataset_name: typing.Optional[str]=None, dataset_uuid: typing.Optional[str]=None) -> None:
        ...
        if dataset_uuid is not None: self._values["dataset_uuid"] = dataset_uuid
...
class JenkinsSpecMasterVolumesGitRepo():
    def __init__(self, *, repository: str, directory: typing.Optional[str]=None, revision: typing.Optional[str]=None) -> None:
        ...
        if directory is not None: self._values["directory"] = directory
...
class JenkinsSpecMasterVolumesIscsi():
    def __init__(self, *, iqn: str, lun: jsii.Number, target_portal: str, chap_auth_discovery: typing.Optional[bool]=None, chap_auth_session: typing.Optional[bool]=None, fs_type: typing.Optional[str]=None, initiator_name: typing.Optional[str]=None, iscsi_interface: typing.Optional[str]=None, portals: typing.Optional[typing.List[str]]=None, read_only: typing.Optional[bool]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesIscsiSecretRef"]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesIscsiSecretRef(**secret_ref)
        self._values = {
            'iqn': iqn,
            'lun': lun,
            'target_portal': target_portal,
        }
        if chap_auth_discovery is not None: self._values["chap_auth_discovery"] = chap_auth_discovery
        if chap_auth_session is not None: self._values["chap_auth_session"] = chap_auth_session
        if fs_type is not None: self._values["fs_type"] = fs_type
        if initiator_name is not None: self._values["initiator_name"] = initiator_name
        if iscsi_interface is not None: self._values["iscsi_interface"] = iscsi_interface
        if portals is not None: self._values["portals"] = portals
        if read_only is not None: self._values["read_only"] = read_only
        if secret_ref is not None: self._values["secret_ref"] = secret_ref
...
class JenkinsSpecMasterVolumesProjectedSources():
    def __init__(self, *, config_map: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesConfigMap"]=None, downward_api: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApi"]=None, secret: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesSecret"]=None, service_account_token: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesServiceAccountToken"]=None) -> None:
        ...
        """
        if isinstance(config_map, dict): config_map = JenkinsSpecMasterVolumesProjectedSourcesConfigMap(**config_map)
        if isinstance(downward_api, dict): downward_api = JenkinsSpecMasterVolumesProjectedSourcesDownwardApi(**downward_api)
        if isinstance(secret, dict): secret = JenkinsSpecMasterVolumesProjectedSourcesSecret(**secret)
        if isinstance(service_account_token, dict): service_account_token = JenkinsSpecMasterVolumesProjectedSourcesServiceAccountToken(**service_account_token)
        self._values = {
        }
        if config_map is not None: self._values["config_map"] = config_map
        if downward_api is not None: self._values["downward_api"] = downward_api
        if secret is not None: self._values["secret"] = secret
        if service_account_token is not None: self._values["service_account_token"] = service_account_token

    @builtins.property
    def config_map(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesConfigMap"]:
    ...
    @builtins.property
    def downward_api(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApi"]:
    ...
    @builtins.property
    def secret(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesSecret"]:
    ...
    @builtins.property
    def service_account_token(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesServiceAccountToken"]:
...
class JenkinsSpecMasterVolumesProjectedSourcesConfigMap():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesProjectedSourcesConfigMapItems"]]:
        """If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value.
...
class JenkinsSpecMasterVolumesProjectedSourcesDownwardApi():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItems"]]:
...
class JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItems():
    def __init__(self, *, path: str, field_ref: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsFieldRef"]=None, mode: typing.Optional[jsii.Number]=None, resource_field_ref: typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsResourceFieldRef"]=None) -> None:
        ...
        """
        if isinstance(field_ref, dict): field_ref = JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsFieldRef(**field_ref)
        if isinstance(resource_field_ref, dict): resource_field_ref = JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsResourceFieldRef(**resource_field_ref)
        self._values = {
            'path': path,
        }
        if field_ref is not None: self._values["field_ref"] = field_ref
    ...
    @builtins.property
    def field_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsFieldRef"]:
        """Required: Selects a field of the pod: only annotations, labels, name and namespace are supported.
    ...
    @builtins.property
    def resource_field_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesProjectedSourcesDownwardApiItemsResourceFieldRef"]:
        """Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported.
...
class JenkinsSpecMasterVolumesProjectedSourcesSecret():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesProjectedSourcesSecretItems"]]:
...
class JenkinsSpecMasterVolumesProjectedSourcesServiceAccountToken():
    def __init__(self, *, path: str, audience: typing.Optional[str]=None, expiration_seconds: typing.Optional[jsii.Number]=None) -> None:
        ...
        if expiration_seconds is not None: self._values["expiration_seconds"] = expiration_seconds
...
class JenkinsSpecMasterVolumesQuobyte():
    def __init__(self, *, registry: str, volume: str, group: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, tenant: typing.Optional[str]=None, user: typing.Optional[str]=None) -> None:
        ...
        if read_only is not None: self._values["read_only"] = read_only
        if tenant is not None: self._values["tenant"] = tenant
        if user is not None: self._values["user"] = user
...
class JenkinsSpecMasterVolumesRbd():
    def __init__(self, *, image: str, monitors: typing.List[str], fs_type: typing.Optional[str]=None, keyring: typing.Optional[str]=None, pool: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesRbdSecretRef"]=None, user: typing.Optional[str]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesRbdSecretRef(**secret_ref)
        self._values = {
            'image': image,
            'monitors': monitors,
        }
        if fs_type is not None: self._values["fs_type"] = fs_type
        if keyring is not None: self._values["keyring"] = keyring
        if pool is not None: self._values["pool"] = pool
        if read_only is not None: self._values["read_only"] = read_only
        if secret_ref is not None: self._values["secret_ref"] = secret_ref
        if user is not None: self._values["user"] = user
...
class JenkinsSpecMasterVolumesScaleIo():
    def __init__(self, *, gateway: str, secret_ref: "JenkinsSpecMasterVolumesScaleIoSecretRef", system: str, fs_type: typing.Optional[str]=None, protection_domain: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, ssl_enabled: typing.Optional[bool]=None, storage_mode: typing.Optional[str]=None, storage_pool: typing.Optional[str]=None, volume_name: typing.Optional[str]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesScaleIoSecretRef(**secret_ref)
        self._values = {
            'gateway': gateway,
        ...
        if fs_type is not None: self._values["fs_type"] = fs_type
        if protection_domain is not None: self._values["protection_domain"] = protection_domain
        if read_only is not None: self._values["read_only"] = read_only
        if ssl_enabled is not None: self._values["ssl_enabled"] = ssl_enabled
        if storage_mode is not None: self._values["storage_mode"] = storage_mode
        if storage_pool is not None: self._values["storage_pool"] = storage_pool
        if volume_name is not None: self._values["volume_name"] = volume_name
...
class JenkinsSpecMasterVolumesSecret():
    ...
    @builtins.property
    def items(self) -> typing.Optional[typing.List["JenkinsSpecMasterVolumesSecretItems"]]:
        """If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value.
...
class JenkinsSpecMasterVolumesStorageos():
    def __init__(self, *, fs_type: typing.Optional[str]=None, read_only: typing.Optional[bool]=None, secret_ref: typing.Optional["JenkinsSpecMasterVolumesStorageosSecretRef"]=None, volume_name: typing.Optional[str]=None, volume_namespace: typing.Optional[str]=None) -> None:
        ...
        """
        if isinstance(secret_ref, dict): secret_ref = JenkinsSpecMasterVolumesStorageosSecretRef(**secret_ref)
        self._values = {
        }
        if fs_type is not None: self._values["fs_type"] = fs_type
        if read_only is not None: self._values["read_only"] = read_only
        if secret_ref is not None: self._values["secret_ref"] = secret_ref
        if volume_name is not None: self._values["volume_name"] = volume_name
        if volume_namespace is not None: self._values["volume_namespace"] = volume_namespace
    ...
    @builtins.property
    def secret_ref(self) -> typing.Optional["JenkinsSpecMasterVolumesStorageosSecretRef"]:
...
class JenkinsSpecMasterVolumesVsphereVolume():
    def __init__(self, *, volume_path: str, fs_type: typing.Optional[str]=None, storage_policy_id: typing.Optional[str]=None, storage_policy_name: typing.Optional[str]=None) -> None:
        ...
        if fs_type is not None: self._values["fs_type"] = fs_type
        if storage_policy_id is not None: self._values["storage_policy_id"] = storage_policy_id
        if storage_policy_name is not None: self._values["storage_policy_name"] = storage_policy_name
...
class JenkinsSpecNotifications():
    def __init__(self, *, level: str, name: str, verbose: bool, mailgun: typing.Optional["JenkinsSpecNotificationsMailgun"]=None, slack: typing.Optional["JenkinsSpecNotificationsSlack"]=None, smtp: typing.Optional["JenkinsSpecNotificationsSmtp"]=None, teams: typing.Optional["JenkinsSpecNotificationsTeams"]=None) -> None:
        ...
        """
        if isinstance(mailgun, dict): mailgun = JenkinsSpecNotificationsMailgun(**mailgun)
        if isinstance(slack, dict): slack = JenkinsSpecNotificationsSlack(**slack)
        if isinstance(smtp, dict): smtp = JenkinsSpecNotificationsSmtp(**smtp)
        if isinstance(teams, dict): teams = JenkinsSpecNotificationsTeams(**teams)
        self._values = {
            'level': level,
            'name': name,
            'verbose': verbose,
        }
        if mailgun is not None: self._values["mailgun"] = mailgun
        if slack is not None: self._values["slack"] = slack
        if smtp is not None: self._values["smtp"] = smtp
        if teams is not None: self._values["teams"] = teams
...
class JenkinsSpecNotificationsMailgun():
    def __init__(self, *, api_key_secret_key_selector: "JenkinsSpecNotificationsMailgunApiKeySecretKeySelector", domain: str, from_: str, recipient: str) -> None:
        ...
        """
        if isinstance(api_key_secret_key_selector, dict): api_key_secret_key_selector = JenkinsSpecNotificationsMailgunApiKeySecretKeySelector(**api_key_secret_key_selector)
        self._values = {
    ...
    @builtins.property
    def api_key_secret_key_selector(self) -> "JenkinsSpecNotificationsMailgunApiKeySecretKeySelector":
...
class JenkinsSpecNotificationsMailgunApiKeySecretKeySelector():
    def __init__(self, *, key: str, secret: "JenkinsSpecNotificationsMailgunApiKeySecretKeySelectorSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecNotificationsMailgunApiKeySecretKeySelectorSecret(**secret)
        self._values = {
            'key': key,
            'secret': secret,
        }
...
class JenkinsSpecNotificationsSlack():
    def __init__(self, *, web_hook_url_secret_key_selector: "JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelector") -> None:
        ...
        """
        if isinstance(web_hook_url_secret_key_selector, dict): web_hook_url_secret_key_selector = JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelector(**web_hook_url_secret_key_selector)
        self._values = {
            'web_hook_url_secret_key_selector': web_hook_url_secret_key_selector,
        }

    @builtins.property
    def web_hook_url_secret_key_selector(self) -> "JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelector":
...
class JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelector():
    def __init__(self, *, key: str, secret: "JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelectorSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelectorSecret(**secret)
        self._values = {
            'key': key,
            'secret': secret,
        }
    ...
    @builtins.property
    def secret(self) -> "JenkinsSpecNotificationsSlackWebHookUrlSecretKeySelectorSecret":
        """The name of the secret in the pod's namespace to select from.
...
class JenkinsSpecNotificationsSmtp():
    def __init__(self, *, from_: str, password_secret_key_selector: "JenkinsSpecNotificationsSmtpPasswordSecretKeySelector", port: jsii.Number, server: str, to: str, username_secret_key_selector: "JenkinsSpecNotificationsSmtpUsernameSecretKeySelector", tls_insecure_skip_verify: typing.Optional[bool]=None) -> None:
        ...
        """
        if isinstance(password_secret_key_selector, dict): password_secret_key_selector = JenkinsSpecNotificationsSmtpPasswordSecretKeySelector(**password_secret_key_selector)
        if isinstance(username_secret_key_selector, dict): username_secret_key_selector = JenkinsSpecNotificationsSmtpUsernameSecretKeySelector(**username_secret_key_selector)
        self._values = {
            'from_': from_,
        ...
        if tls_insecure_skip_verify is not None: self._values["tls_insecure_skip_verify"] = tls_insecure_skip_verify
    ...
    @builtins.property
    def password_secret_key_selector(self) -> "JenkinsSpecNotificationsSmtpPasswordSecretKeySelector":
        """SecretKeySelector selects a key of a Secret.
    ...
    @builtins.property
    def username_secret_key_selector(self) -> "JenkinsSpecNotificationsSmtpUsernameSecretKeySelector":
        """SecretKeySelector selects a key of a Secret.
...
class JenkinsSpecNotificationsSmtpPasswordSecretKeySelector():
    def __init__(self, *, key: str, secret: "JenkinsSpecNotificationsSmtpPasswordSecretKeySelectorSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecNotificationsSmtpPasswordSecretKeySelectorSecret(**secret)
        self._values = {
            'key': key,
            'secret': secret,
        }
...
class JenkinsSpecNotificationsSmtpUsernameSecretKeySelector():
    def __init__(self, *, key: str, secret: "JenkinsSpecNotificationsSmtpUsernameSecretKeySelectorSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecNotificationsSmtpUsernameSecretKeySelectorSecret(**secret)
        self._values = {
            'key': key,
            'secret': secret,
        }
...
class JenkinsSpecNotificationsTeams():
    def __init__(self, *, web_hook_url_secret_key_selector: "JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelector") -> None:
        ...
        """
        if isinstance(web_hook_url_secret_key_selector, dict): web_hook_url_secret_key_selector = JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelector(**web_hook_url_secret_key_selector)
        self._values = {
            'web_hook_url_secret_key_selector': web_hook_url_secret_key_selector,
        }

    @builtins.property
    def web_hook_url_secret_key_selector(self) -> "JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelector":
...
class JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelector():
    def __init__(self, *, key: str, secret: "JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelectorSecret") -> None:
        ...
        """
        if isinstance(secret, dict): secret = JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelectorSecret(**secret)
        self._values = {
            'key': key,
            'secret': secret,
        }
    ...
    @builtins.property
    def secret(self) -> "JenkinsSpecNotificationsTeamsWebHookUrlSecretKeySelectorSecret":
        """The name of the secret in the pod's namespace to select from.
...
class JenkinsSpecRestore():
    def __init__(self, *, action: "JenkinsSpecRestoreAction", container_name: str, recovery_once: typing.Optional[jsii.Number]=None) -> None:
        ...
        """
        if isinstance(action, dict): action = JenkinsSpecRestoreAction(**action)
        self._values = {
            'action': action,
            'container_name': container_name,
        }
        if recovery_once is not None: self._values["recovery_once"] = recovery_once
...
class JenkinsSpecRestoreAction():
    def __init__(self, *, exec: typing.Optional["JenkinsSpecRestoreActionExec"]=None) -> None:
        ...
        """
        if isinstance(exec, dict): exec = JenkinsSpecRestoreActionExec(**exec)
        self._values = {
        }
        if exec is not None: self._values["exec"] = exec
...
class JenkinsSpecSeedJobs():
    def __init__(self, *, additional_classpath: typing.Optional[str]=None, bitbucket_push_trigger: typing.Optional[bool]=None, build_periodically: typing.Optional[str]=None, credential_id: typing.Optional[str]=None, credential_type: typing.Optional[str]=None, description: typing.Optional[str]=None, fail_on_missing_plugin: typing.Optional[bool]=None, github_push_trigger: typing.Optional[bool]=None, id: typing.Optional[str]=None, ignore_missing_files: typing.Optional[bool]=None, poll_scm: typing.Optional[str]=None, repository_branch: typing.Optional[str]=None, repository_url: typing.Optional[str]=None, targets: typing.Optional[str]=None, unstable_on_deprecation: typing.Optional[bool]=None) -> None:
        ...
        if additional_classpath is not None: self._values["additional_classpath"] = additional_classpath
        if bitbucket_push_trigger is not None: self._values["bitbucket_push_trigger"] = bitbucket_push_trigger
        if build_periodically is not None: self._values["build_periodically"] = build_periodically
        if credential_id is not None: self._values["credential_id"] = credential_id
        if credential_type is not None: self._values["credential_type"] = credential_type
        if description is not None: self._values["description"] = description
        if fail_on_missing_plugin is not None: self._values["fail_on_missing_plugin"] = fail_on_missing_plugin
        if github_push_trigger is not None: self._values["github_push_trigger"] = github_push_trigger
        if id is not None: self._values["id"] = id
        if ignore_missing_files is not None: self._values["ignore_missing_files"] = ignore_missing_files
        if poll_scm is not None: self._values["poll_scm"] = poll_scm
        if repository_branch is not None: self._values["repository_branch"] = repository_branch
        if repository_url is not None: self._values["repository_url"] = repository_url
        if targets is not None: self._values["targets"] = targets
        if unstable_on_deprecation is not None: self._values["unstable_on_deprecation"] = unstable_on_deprecation
...
class JenkinsSpecService():
    def __init__(self, *, annotations: typing.Optional[typing.Mapping[str, str]]=None, labels: typing.Optional[typing.Mapping[str, str]]=None, load_balancer_ip: typing.Optional[str]=None, load_balancer_source_ranges: typing.Optional[typing.List[str]]=None, node_port: typing.Optional[jsii.Number]=None, port: typing.Optional[jsii.Number]=None, type: typing.Optional[str]=None) -> None:
        ...
        if annotations is not None: self._values["annotations"] = annotations
        if labels is not None: self._values["labels"] = labels
        if load_balancer_ip is not None: self._values["load_balancer_ip"] = load_balancer_ip
        if load_balancer_source_ranges is not None: self._values["load_balancer_source_ranges"] = load_balancer_source_ranges
