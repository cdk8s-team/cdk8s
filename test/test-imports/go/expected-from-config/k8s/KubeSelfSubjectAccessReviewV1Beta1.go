...
func NewKubeSelfSubjectAccessReviewV1Beta1(scope constructs.Construct, id *string, props *KubeSelfSubjectAccessReviewV1Beta1Props) KubeSelfSubjectAccessReviewV1Beta1 {
	...
	if err := validateNewKubeSelfSubjectAccessReviewV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeSelfSubjectAccessReviewV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeSelfSubjectAccessReviewV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSelfSubjectAccessReviewV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeSelfSubjectAccessReviewV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSelfSubjectAccessReviewV1Beta1_Manifest(props *KubeSelfSubjectAccessReviewV1Beta1Props) interface{} {
	...
	if err := validateKubeSelfSubjectAccessReviewV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeSelfSubjectAccessReviewV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeSelfSubjectAccessReviewV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
