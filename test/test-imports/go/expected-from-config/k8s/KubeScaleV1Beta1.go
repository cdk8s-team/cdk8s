...
func NewKubeScaleV1Beta1(scope constructs.Construct, id *string, props *KubeScaleV1Beta1Props) KubeScaleV1Beta1 {
	...
	if err := validateNewKubeScaleV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeScaleV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeScaleV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeScaleV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeScaleV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeScaleV1Beta1_Manifest(props *KubeScaleV1Beta1Props) interface{} {
	...
	if err := validateKubeScaleV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeScaleV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeScaleV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
