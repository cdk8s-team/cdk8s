...
func NewKubeDaemonSetV1Beta1(scope constructs.Construct, id *string, props *KubeDaemonSetV1Beta1Props) KubeDaemonSetV1Beta1 {
	...
	if err := validateNewKubeDaemonSetV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeDaemonSetV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeDaemonSetV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetV1Beta1_Manifest(props *KubeDaemonSetV1Beta1Props) interface{} {
	...
	if err := validateKubeDaemonSetV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeDaemonSetV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
