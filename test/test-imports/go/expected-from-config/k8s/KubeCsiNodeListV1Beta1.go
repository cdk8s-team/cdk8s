...
func NewKubeCsiNodeListV1Beta1(scope constructs.Construct, id *string, props *KubeCsiNodeListV1Beta1Props) KubeCsiNodeListV1Beta1 {
	...
	if err := validateNewKubeCsiNodeListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCsiNodeListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeCsiNodeListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiNodeListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCsiNodeListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiNodeListV1Beta1_Manifest(props *KubeCsiNodeListV1Beta1Props) interface{} {
	...
	if err := validateKubeCsiNodeListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCsiNodeListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCsiNodeListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
