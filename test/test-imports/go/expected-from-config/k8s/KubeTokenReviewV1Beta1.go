...
func NewKubeTokenReviewV1Beta1(scope constructs.Construct, id *string, props *KubeTokenReviewV1Beta1Props) KubeTokenReviewV1Beta1 {
	...
	if err := validateNewKubeTokenReviewV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeTokenReviewV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeTokenReviewV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeTokenReviewV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeTokenReviewV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeTokenReviewV1Beta1_Manifest(props *KubeTokenReviewV1Beta1Props) interface{} {
	...
	if err := validateKubeTokenReviewV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeTokenReviewV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeTokenReviewV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
