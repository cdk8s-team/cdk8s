...
func NewKubePriorityClassV1Beta1(scope constructs.Construct, id *string, props *KubePriorityClassV1Beta1Props) KubePriorityClassV1Beta1 {
	...
	if err := validateNewKubePriorityClassV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubePriorityClassV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubePriorityClassV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubePriorityClassV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubePriorityClassV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubePriorityClassV1Beta1_Manifest(props *KubePriorityClassV1Beta1Props) interface{} {
	...
	if err := validateKubePriorityClassV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubePriorityClassV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubePriorityClassV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
