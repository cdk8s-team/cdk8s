...
func NewKubeMutatingWebhookConfigurationListV1Beta1(scope constructs.Construct, id *string, props *KubeMutatingWebhookConfigurationListV1Beta1Props) KubeMutatingWebhookConfigurationListV1Beta1 {
	...
	if err := validateNewKubeMutatingWebhookConfigurationListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeMutatingWebhookConfigurationListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeMutatingWebhookConfigurationListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeMutatingWebhookConfigurationListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeMutatingWebhookConfigurationListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeMutatingWebhookConfigurationListV1Beta1_Manifest(props *KubeMutatingWebhookConfigurationListV1Beta1Props) interface{} {
	...
	if err := validateKubeMutatingWebhookConfigurationListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeMutatingWebhookConfigurationListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeMutatingWebhookConfigurationListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
