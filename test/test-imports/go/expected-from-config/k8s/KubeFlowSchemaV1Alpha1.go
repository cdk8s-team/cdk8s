...
func NewKubeFlowSchemaV1Alpha1(scope constructs.Construct, id *string, props *KubeFlowSchemaV1Alpha1Props) KubeFlowSchemaV1Alpha1 {
	...
	if err := validateNewKubeFlowSchemaV1Alpha1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeFlowSchemaV1Alpha1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeFlowSchemaV1Alpha1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeFlowSchemaV1Alpha1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeFlowSchemaV1Alpha1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeFlowSchemaV1Alpha1_Manifest(props *KubeFlowSchemaV1Alpha1Props) interface{} {
	...
	if err := validateKubeFlowSchemaV1Alpha1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeFlowSchemaV1Alpha1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeFlowSchemaV1Alpha1_OfParameters(c); err != nil {
		panic(err)
	}
