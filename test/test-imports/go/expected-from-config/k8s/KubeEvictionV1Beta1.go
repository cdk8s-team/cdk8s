...
func NewKubeEvictionV1Beta1(scope constructs.Construct, id *string, props *KubeEvictionV1Beta1Props) KubeEvictionV1Beta1 {
	...
	if err := validateNewKubeEvictionV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeEvictionV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeEvictionV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeEvictionV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeEvictionV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeEvictionV1Beta1_Manifest(props *KubeEvictionV1Beta1Props) interface{} {
	...
	if err := validateKubeEvictionV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeEvictionV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeEvictionV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
