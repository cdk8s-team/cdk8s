...
func NewKubeApiServiceV1Beta1(scope constructs.Construct, id *string, props *KubeApiServiceV1Beta1Props) KubeApiServiceV1Beta1 {
	...
	if err := validateNewKubeApiServiceV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeApiServiceV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeApiServiceV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeApiServiceV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceV1Beta1_Manifest(props *KubeApiServiceV1Beta1Props) interface{} {
	...
	if err := validateKubeApiServiceV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeApiServiceV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeApiServiceV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
