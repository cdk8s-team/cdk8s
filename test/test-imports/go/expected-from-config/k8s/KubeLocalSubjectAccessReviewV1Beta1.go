...
func NewKubeLocalSubjectAccessReviewV1Beta1(scope constructs.Construct, id *string, props *KubeLocalSubjectAccessReviewV1Beta1Props) KubeLocalSubjectAccessReviewV1Beta1 {
	...
	if err := validateNewKubeLocalSubjectAccessReviewV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeLocalSubjectAccessReviewV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeLocalSubjectAccessReviewV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeLocalSubjectAccessReviewV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeLocalSubjectAccessReviewV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeLocalSubjectAccessReviewV1Beta1_Manifest(props *KubeLocalSubjectAccessReviewV1Beta1Props) interface{} {
	...
	if err := validateKubeLocalSubjectAccessReviewV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeLocalSubjectAccessReviewV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeLocalSubjectAccessReviewV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
