...
func NewKubeClusterRoleListV1Beta1(scope constructs.Construct, id *string, props *KubeClusterRoleListV1Beta1Props) KubeClusterRoleListV1Beta1 {
	...
	if err := validateNewKubeClusterRoleListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeClusterRoleListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeClusterRoleListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleListV1Beta1_Manifest(props *KubeClusterRoleListV1Beta1Props) interface{} {
	...
	if err := validateKubeClusterRoleListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeClusterRoleListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
