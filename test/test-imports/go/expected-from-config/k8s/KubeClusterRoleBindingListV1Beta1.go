...
func NewKubeClusterRoleBindingListV1Beta1(scope constructs.Construct, id *string, props *KubeClusterRoleBindingListV1Beta1Props) KubeClusterRoleBindingListV1Beta1 {
	...
	if err := validateNewKubeClusterRoleBindingListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleBindingListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeClusterRoleBindingListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleBindingListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeClusterRoleBindingListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleBindingListV1Beta1_Manifest(props *KubeClusterRoleBindingListV1Beta1Props) interface{} {
	...
	if err := validateKubeClusterRoleBindingListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleBindingListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeClusterRoleBindingListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
