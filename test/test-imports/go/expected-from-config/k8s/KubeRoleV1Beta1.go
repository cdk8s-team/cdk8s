...
func NewKubeRoleV1Beta1(scope constructs.Construct, id *string, props *KubeRoleV1Beta1Props) KubeRoleV1Beta1 {
	...
	if err := validateNewKubeRoleV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeRoleV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeRoleV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeRoleV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeRoleV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeRoleV1Beta1_Manifest(props *KubeRoleV1Beta1Props) interface{} {
	...
	if err := validateKubeRoleV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeRoleV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeRoleV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
