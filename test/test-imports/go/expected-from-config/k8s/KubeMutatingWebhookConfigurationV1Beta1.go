...
func NewKubeMutatingWebhookConfigurationV1Beta1(scope constructs.Construct, id *string, props *KubeMutatingWebhookConfigurationV1Beta1Props) KubeMutatingWebhookConfigurationV1Beta1 {
	...
	if err := validateNewKubeMutatingWebhookConfigurationV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeMutatingWebhookConfigurationV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeMutatingWebhookConfigurationV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeMutatingWebhookConfigurationV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeMutatingWebhookConfigurationV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeMutatingWebhookConfigurationV1Beta1_Manifest(props *KubeMutatingWebhookConfigurationV1Beta1Props) interface{} {
	...
	if err := validateKubeMutatingWebhookConfigurationV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeMutatingWebhookConfigurationV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeMutatingWebhookConfigurationV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
