...
func NewKubeLeaseListV1Beta1(scope constructs.Construct, id *string, props *KubeLeaseListV1Beta1Props) KubeLeaseListV1Beta1 {
	...
	if err := validateNewKubeLeaseListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeLeaseListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeLeaseListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeLeaseListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeLeaseListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeLeaseListV1Beta1_Manifest(props *KubeLeaseListV1Beta1Props) interface{} {
	...
	if err := validateKubeLeaseListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeLeaseListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeLeaseListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
