...
func NewKubeClusterRoleBindingV1Beta1(scope constructs.Construct, id *string, props *KubeClusterRoleBindingV1Beta1Props) KubeClusterRoleBindingV1Beta1 {
	...
	if err := validateNewKubeClusterRoleBindingV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleBindingV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeClusterRoleBindingV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleBindingV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeClusterRoleBindingV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeClusterRoleBindingV1Beta1_Manifest(props *KubeClusterRoleBindingV1Beta1Props) interface{} {
	...
	if err := validateKubeClusterRoleBindingV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeClusterRoleBindingV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeClusterRoleBindingV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
