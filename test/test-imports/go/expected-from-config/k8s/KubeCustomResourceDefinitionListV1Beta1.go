...
func NewKubeCustomResourceDefinitionListV1Beta1(scope constructs.Construct, id *string, props *KubeCustomResourceDefinitionListV1Beta1Props) KubeCustomResourceDefinitionListV1Beta1 {
	...
	if err := validateNewKubeCustomResourceDefinitionListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCustomResourceDefinitionListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeCustomResourceDefinitionListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCustomResourceDefinitionListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCustomResourceDefinitionListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCustomResourceDefinitionListV1Beta1_Manifest(props *KubeCustomResourceDefinitionListV1Beta1Props) interface{} {
	...
	if err := validateKubeCustomResourceDefinitionListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCustomResourceDefinitionListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCustomResourceDefinitionListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
