...
func NewKubeValidatingWebhookConfigurationV1Beta1(scope constructs.Construct, id *string, props *KubeValidatingWebhookConfigurationV1Beta1Props) KubeValidatingWebhookConfigurationV1Beta1 {
	...
	if err := validateNewKubeValidatingWebhookConfigurationV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeValidatingWebhookConfigurationV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeValidatingWebhookConfigurationV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeValidatingWebhookConfigurationV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeValidatingWebhookConfigurationV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeValidatingWebhookConfigurationV1Beta1_Manifest(props *KubeValidatingWebhookConfigurationV1Beta1Props) interface{} {
	...
	if err := validateKubeValidatingWebhookConfigurationV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeValidatingWebhookConfigurationV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeValidatingWebhookConfigurationV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
