...
func NewKubeCsiNodeV1Beta1(scope constructs.Construct, id *string, props *KubeCsiNodeV1Beta1Props) KubeCsiNodeV1Beta1 {
	...
	if err := validateNewKubeCsiNodeV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCsiNodeV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeCsiNodeV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiNodeV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCsiNodeV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiNodeV1Beta1_Manifest(props *KubeCsiNodeV1Beta1Props) interface{} {
	...
	if err := validateKubeCsiNodeV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCsiNodeV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCsiNodeV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
