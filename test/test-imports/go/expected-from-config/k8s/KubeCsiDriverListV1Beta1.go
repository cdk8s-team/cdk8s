...
func NewKubeCsiDriverListV1Beta1(scope constructs.Construct, id *string, props *KubeCsiDriverListV1Beta1Props) KubeCsiDriverListV1Beta1 {
	...
	if err := validateNewKubeCsiDriverListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCsiDriverListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeCsiDriverListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiDriverListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCsiDriverListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiDriverListV1Beta1_Manifest(props *KubeCsiDriverListV1Beta1Props) interface{} {
	...
	if err := validateKubeCsiDriverListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCsiDriverListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCsiDriverListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
