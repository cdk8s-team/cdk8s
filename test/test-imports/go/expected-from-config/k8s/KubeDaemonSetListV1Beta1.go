...
func NewKubeDaemonSetListV1Beta1(scope constructs.Construct, id *string, props *KubeDaemonSetListV1Beta1Props) KubeDaemonSetListV1Beta1 {
	...
	if err := validateNewKubeDaemonSetListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeDaemonSetListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeDaemonSetListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetListV1Beta1_Manifest(props *KubeDaemonSetListV1Beta1Props) interface{} {
	...
	if err := validateKubeDaemonSetListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeDaemonSetListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
