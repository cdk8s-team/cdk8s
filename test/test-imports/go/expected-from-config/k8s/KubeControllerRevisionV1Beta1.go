...
func NewKubeControllerRevisionV1Beta1(scope constructs.Construct, id *string, props *KubeControllerRevisionV1Beta1Props) KubeControllerRevisionV1Beta1 {
	...
	if err := validateNewKubeControllerRevisionV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeControllerRevisionV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeControllerRevisionV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeControllerRevisionV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeControllerRevisionV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeControllerRevisionV1Beta1_Manifest(props *KubeControllerRevisionV1Beta1Props) interface{} {
	...
	if err := validateKubeControllerRevisionV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeControllerRevisionV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeControllerRevisionV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
