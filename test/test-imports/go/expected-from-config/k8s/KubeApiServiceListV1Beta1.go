...
func NewKubeApiServiceListV1Beta1(scope constructs.Construct, id *string, props *KubeApiServiceListV1Beta1Props) KubeApiServiceListV1Beta1 {
	...
	if err := validateNewKubeApiServiceListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeApiServiceListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeApiServiceListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeApiServiceListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceListV1Beta1_Manifest(props *KubeApiServiceListV1Beta1Props) interface{} {
	...
	if err := validateKubeApiServiceListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeApiServiceListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeApiServiceListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
