...
func NewKubeDeploymentV1Beta1(scope constructs.Construct, id *string, props *KubeDeploymentV1Beta1Props) KubeDeploymentV1Beta1 {
	...
	if err := validateNewKubeDeploymentV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeDeploymentV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeDeploymentV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDeploymentV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeDeploymentV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDeploymentV1Beta1_Manifest(props *KubeDeploymentV1Beta1Props) interface{} {
	...
	if err := validateKubeDeploymentV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeDeploymentV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeDeploymentV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
