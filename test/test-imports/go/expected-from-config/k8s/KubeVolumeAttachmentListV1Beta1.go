...
func NewKubeVolumeAttachmentListV1Beta1(scope constructs.Construct, id *string, props *KubeVolumeAttachmentListV1Beta1Props) KubeVolumeAttachmentListV1Beta1 {
	...
	if err := validateNewKubeVolumeAttachmentListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeVolumeAttachmentListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeVolumeAttachmentListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeVolumeAttachmentListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeVolumeAttachmentListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeVolumeAttachmentListV1Beta1_Manifest(props *KubeVolumeAttachmentListV1Beta1Props) interface{} {
	...
	if err := validateKubeVolumeAttachmentListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeVolumeAttachmentListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeVolumeAttachmentListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
