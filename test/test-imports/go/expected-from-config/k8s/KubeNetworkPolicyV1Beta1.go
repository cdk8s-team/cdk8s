...
func NewKubeNetworkPolicyV1Beta1(scope constructs.Construct, id *string, props *KubeNetworkPolicyV1Beta1Props) KubeNetworkPolicyV1Beta1 {
	...
	if err := validateNewKubeNetworkPolicyV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeNetworkPolicyV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeNetworkPolicyV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeNetworkPolicyV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeNetworkPolicyV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeNetworkPolicyV1Beta1_Manifest(props *KubeNetworkPolicyV1Beta1Props) interface{} {
	...
	if err := validateKubeNetworkPolicyV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeNetworkPolicyV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeNetworkPolicyV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
