...
func NewKubeStatefulSetListV1Beta1(scope constructs.Construct, id *string, props *KubeStatefulSetListV1Beta1Props) KubeStatefulSetListV1Beta1 {
	...
	if err := validateNewKubeStatefulSetListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeStatefulSetListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeStatefulSetListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeStatefulSetListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeStatefulSetListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeStatefulSetListV1Beta1_Manifest(props *KubeStatefulSetListV1Beta1Props) interface{} {
	...
	if err := validateKubeStatefulSetListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeStatefulSetListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeStatefulSetListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
