...
func NewKubeFlowSchemaListV1Alpha1(scope constructs.Construct, id *string, props *KubeFlowSchemaListV1Alpha1Props) KubeFlowSchemaListV1Alpha1 {
	...
	if err := validateNewKubeFlowSchemaListV1Alpha1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeFlowSchemaListV1Alpha1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeFlowSchemaListV1Alpha1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeFlowSchemaListV1Alpha1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeFlowSchemaListV1Alpha1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeFlowSchemaListV1Alpha1_Manifest(props *KubeFlowSchemaListV1Alpha1Props) interface{} {
	...
	if err := validateKubeFlowSchemaListV1Alpha1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeFlowSchemaListV1Alpha1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeFlowSchemaListV1Alpha1_OfParameters(c); err != nil {
		panic(err)
	}
