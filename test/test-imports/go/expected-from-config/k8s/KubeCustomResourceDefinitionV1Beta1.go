...
func NewKubeCustomResourceDefinitionV1Beta1(scope constructs.Construct, id *string, props *KubeCustomResourceDefinitionV1Beta1Props) KubeCustomResourceDefinitionV1Beta1 {
	...
	if err := validateNewKubeCustomResourceDefinitionV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCustomResourceDefinitionV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeCustomResourceDefinitionV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCustomResourceDefinitionV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCustomResourceDefinitionV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCustomResourceDefinitionV1Beta1_Manifest(props *KubeCustomResourceDefinitionV1Beta1Props) interface{} {
	...
	if err := validateKubeCustomResourceDefinitionV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCustomResourceDefinitionV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCustomResourceDefinitionV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
