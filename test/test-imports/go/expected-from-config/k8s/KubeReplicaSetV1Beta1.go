...
func NewKubeReplicaSetV1Beta1(scope constructs.Construct, id *string, props *KubeReplicaSetV1Beta1Props) KubeReplicaSetV1Beta1 {
	...
	if err := validateNewKubeReplicaSetV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeReplicaSetV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeReplicaSetV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetV1Beta1_Manifest(props *KubeReplicaSetV1Beta1Props) interface{} {
	...
	if err := validateKubeReplicaSetV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeReplicaSetV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
