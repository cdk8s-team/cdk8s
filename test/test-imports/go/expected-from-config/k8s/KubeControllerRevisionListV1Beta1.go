...
func NewKubeControllerRevisionListV1Beta1(scope constructs.Construct, id *string, props *KubeControllerRevisionListV1Beta1Props) KubeControllerRevisionListV1Beta1 {
	...
	if err := validateNewKubeControllerRevisionListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeControllerRevisionListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeControllerRevisionListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeControllerRevisionListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeControllerRevisionListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeControllerRevisionListV1Beta1_Manifest(props *KubeControllerRevisionListV1Beta1Props) interface{} {
	...
	if err := validateKubeControllerRevisionListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeControllerRevisionListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeControllerRevisionListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
