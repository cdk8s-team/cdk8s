...
func NewKubeReplicaSetV1Beta2(scope constructs.Construct, id *string, props *KubeReplicaSetV1Beta2Props) KubeReplicaSetV1Beta2 {
	...
	if err := validateNewKubeReplicaSetV1Beta2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetV1Beta2_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeReplicaSetV1Beta2_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetV1Beta2_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeReplicaSetV1Beta2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetV1Beta2_Manifest(props *KubeReplicaSetV1Beta2Props) interface{} {
	...
	if err := validateKubeReplicaSetV1Beta2_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetV1Beta2_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeReplicaSetV1Beta2_OfParameters(c); err != nil {
		panic(err)
	}
