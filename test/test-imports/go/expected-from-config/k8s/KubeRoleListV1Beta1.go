...
func NewKubeRoleListV1Beta1(scope constructs.Construct, id *string, props *KubeRoleListV1Beta1Props) KubeRoleListV1Beta1 {
	...
	if err := validateNewKubeRoleListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeRoleListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeRoleListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeRoleListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeRoleListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeRoleListV1Beta1_Manifest(props *KubeRoleListV1Beta1Props) interface{} {
	...
	if err := validateKubeRoleListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeRoleListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeRoleListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
