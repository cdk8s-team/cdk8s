...
func NewKubeSubjectAccessReviewV1Beta1(scope constructs.Construct, id *string, props *KubeSubjectAccessReviewV1Beta1Props) KubeSubjectAccessReviewV1Beta1 {
	...
	if err := validateNewKubeSubjectAccessReviewV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeSubjectAccessReviewV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeSubjectAccessReviewV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSubjectAccessReviewV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeSubjectAccessReviewV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSubjectAccessReviewV1Beta1_Manifest(props *KubeSubjectAccessReviewV1Beta1Props) interface{} {
	...
	if err := validateKubeSubjectAccessReviewV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeSubjectAccessReviewV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeSubjectAccessReviewV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
