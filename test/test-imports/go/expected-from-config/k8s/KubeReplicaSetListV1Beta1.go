...
func NewKubeReplicaSetListV1Beta1(scope constructs.Construct, id *string, props *KubeReplicaSetListV1Beta1Props) KubeReplicaSetListV1Beta1 {
	...
	if err := validateNewKubeReplicaSetListV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetListV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeReplicaSetListV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetListV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeReplicaSetListV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeReplicaSetListV1Beta1_Manifest(props *KubeReplicaSetListV1Beta1Props) interface{} {
	...
	if err := validateKubeReplicaSetListV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeReplicaSetListV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeReplicaSetListV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
