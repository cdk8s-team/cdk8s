...
func NewKubeSelfSubjectRulesReviewV1Beta1(scope constructs.Construct, id *string, props *KubeSelfSubjectRulesReviewV1Beta1Props) KubeSelfSubjectRulesReviewV1Beta1 {
	...
	if err := validateNewKubeSelfSubjectRulesReviewV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeSelfSubjectRulesReviewV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeSelfSubjectRulesReviewV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSelfSubjectRulesReviewV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeSelfSubjectRulesReviewV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeSelfSubjectRulesReviewV1Beta1_Manifest(props *KubeSelfSubjectRulesReviewV1Beta1Props) interface{} {
	...
	if err := validateKubeSelfSubjectRulesReviewV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeSelfSubjectRulesReviewV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeSelfSubjectRulesReviewV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
