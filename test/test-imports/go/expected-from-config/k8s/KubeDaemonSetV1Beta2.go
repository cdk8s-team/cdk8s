...
func NewKubeDaemonSetV1Beta2(scope constructs.Construct, id *string, props *KubeDaemonSetV1Beta2Props) KubeDaemonSetV1Beta2 {
	...
	if err := validateNewKubeDaemonSetV1Beta2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetV1Beta2_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeDaemonSetV1Beta2_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetV1Beta2_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeDaemonSetV1Beta2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSetV1Beta2_Manifest(props *KubeDaemonSetV1Beta2Props) interface{} {
	...
	if err := validateKubeDaemonSetV1Beta2_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeDaemonSetV1Beta2_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeDaemonSetV1Beta2_OfParameters(c); err != nil {
		panic(err)
	}
