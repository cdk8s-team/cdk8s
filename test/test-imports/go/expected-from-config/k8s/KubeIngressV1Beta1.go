...
func NewKubeIngressV1Beta1(scope constructs.Construct, id *string, props *KubeIngressV1Beta1Props) KubeIngressV1Beta1 {
	...
	if err := validateNewKubeIngressV1Beta1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeIngressV1Beta1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeIngressV1Beta1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeIngressV1Beta1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeIngressV1Beta1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeIngressV1Beta1_Manifest(props *KubeIngressV1Beta1Props) interface{} {
	...
	if err := validateKubeIngressV1Beta1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeIngressV1Beta1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeIngressV1Beta1_OfParameters(c); err != nil {
		panic(err)
	}
