...
func NewKubePodPresetListV1Alpha1(scope constructs.Construct, id *string, props *KubePodPresetListV1Alpha1Props) KubePodPresetListV1Alpha1 {
	...
	if err := validateNewKubePodPresetListV1Alpha1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubePodPresetListV1Alpha1_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubePodPresetListV1Alpha1_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubePodPresetListV1Alpha1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubePodPresetListV1Alpha1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubePodPresetListV1Alpha1_Manifest(props *KubePodPresetListV1Alpha1Props) interface{} {
	...
	if err := validateKubePodPresetListV1Alpha1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubePodPresetListV1Alpha1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubePodPresetListV1Alpha1_OfParameters(c); err != nil {
		panic(err)
	}
