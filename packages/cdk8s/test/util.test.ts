...
describe('sanitizeValue', () => {
  ...
  test('default options', () => {
    ...
    expect(sanitizeValue({ xoo: { }, foo: { bar: { zoo: undefined, hey: { }, me: 123 }} })).toStrictEqual({ xoo: { }, foo: { bar: { hey: { }, me: 123 } } });
    expect(sanitizeValue({ xoo: 123, foo: [ 1, 2, { foo: 123, bar: undefined, zoo: [] }, 3 ] })).toStrictEqual({ xoo: 123, foo: [ 1, 2, { foo: 123, zoo: [ ] }, 3 ] });
